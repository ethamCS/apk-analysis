...
public abstract class f<K, V> {
    ...
    final class a<T> implements Iterator<T> {
        ...
        public boolean hasNext() {
            return this.f2150d < this.f2149c;
        }

        @Override // java.util.Iterator
        public T next() {
            if (hasNext()) {
                T t = (T) f.this.b(this.f2150d, this.f2148b);
                this.f2150d++;
                this.f2151e = true;
                return t;
            }
    ...
    final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            if (this.f2157d) {
                ...
                Map.Entry entry = (Map.Entry) obj;
                return b.d.c.c(entry.getKey(), f.this.b(this.f2156c, 0)) && b.d.c.c(entry.getValue(), f.this.b(this.f2156c, 1));
            }
        ...
        public K getKey() {
            if (this.f2157d) {
                return (K) f.this.b(this.f2156c, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public V getValue() {
            if (this.f2157d) {
                return (V) f.this.b(this.f2156c, 1);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public int hashCode() {
            if (this.f2157d) {
                int i = 0;
                Object b2 = f.this.b(this.f2156c, 0);
                Object b3 = f.this.b(this.f2156c, 1);
        ...
        public V setValue(V v) {
            if (this.f2157d) {
                return (V) f.this.i(this.f2156c, v);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
