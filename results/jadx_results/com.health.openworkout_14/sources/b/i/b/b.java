...
class b {
    ...
    /* loaded from: classes.dex */
    public interface AbstractC0058b<T, V> {
        int a(T t);
    ...
    public static class c<T> implements Comparator<T> {
        ...
        /* renamed from: a */
        private final Rect f2612a = new Rect();

        /* renamed from: b */
        private final Rect f2613b = new Rect();

        /* renamed from: c */
        private final boolean f2614c;

        /* renamed from: d */
        private final a<T> f2615d;
        ...
        public int compare(T t, T t2) {
            ...
            Rect rect2 = this.f2613b;
            this.f2615d.a(t, rect);
            this.f2615d.a(t2, rect2);
            int i = rect.top;
            int i2 = rect2.top;
            if (i < i2) {
                return -1;
    ...
    */
    public static <L, T> T c(L r7, b.i.b.b.AbstractC0058b<L, T> r8, b.i.b.b.a<T> r9, T r10, android.graphics.Rect r11, int r12) {
        /*
        ...
        L64:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: b.i.b.b.c(java.lang.Object, b.i.b.b$b, b.i.b.b$a, java.lang.Object, android.graphics.Rect, int):java.lang.Object");
    }

    public static <L, T> T d(L l, AbstractC0058b<L, T> abstractC0058b, a<T> aVar, T t, int i, boolean z, boolean z2) {
        int a2 = abstractC0058b.a(l);
        ArrayList arrayList = new ArrayList(a2);
        for (int i2 = 0; i2 < a2; i2++) {
            arrayList.add(abstractC0058b.b(l, i2));
        }
