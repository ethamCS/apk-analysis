...
public final class b {
    ...
    /* renamed from: a */
    static final Type[] f3750a = new Type[0];

    /* loaded from: classes.dex */
    public static final class a implements GenericArrayType, Serializable {

        /* renamed from: b */
        private final Type f3751b;

        public a(Type type) {
            this.f3751b = b.b(type);
        }
        ...
        public String toString() {
            return b.u(this.f3751b) + "[]";
        }
    }

    /* renamed from: d.a.b.w.b$b */
    /* loaded from: classes.dex */
    public static final class C0107b implements ParameterizedType, Serializable {

        /* renamed from: b */
        private final Type f3752b;

        /* renamed from: c */
        private final Type f3753c;

        /* renamed from: d */
        private final Type[] f3754d;

        public C0107b(Type type, Type type2, Type... typeArr) {
            ...
            this.f3752b = type == null ? null : b.b(type);
            this.f3753c = b.b(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f3754d = typeArr2;
            int length = typeArr2.length;
            for (int i = 0; i < length; i++) {
                d.a.b.w.a.b(this.f3754d[i]);
                b.c(this.f3754d[i]);
                Type[] typeArr3 = this.f3754d;
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f3754d) ^ this.f3753c.hashCode()) ^ b.m(this.f3752b);
        }

        public String toString() {
            int length = this.f3754d.length;
            if (length == 0) {
                return b.u(this.f3753c);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.u(this.f3753c));
            sb.append("<");
            sb.append(b.u(this.f3754d[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ");
                sb.append(b.u(this.f3754d[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: b */
        private final Type f3755b;

        /* renamed from: c */
        private final Type f3756c;

        public c(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            d.a.b.w.a.a(typeArr2.length <= 1);
            d.a.b.w.a.a(typeArr.length == 1);
            if (typeArr2.length != 1) {
                d.a.b.w.a.b(typeArr[0]);
                b.c(typeArr[0]);
                this.f3756c = null;
                this.f3755b = b.b(typeArr[0]);
                return;
            }
            d.a.b.w.a.b(typeArr2[0]);
            b.c(typeArr2[0]);
            d.a.b.w.a.a(typeArr[0] != Object.class ? false : z);
            this.f3756c = b.b(typeArr2[0]);
            this.f3755b = Object.class;
        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f3756c;
            return type != null ? new Type[]{type} : b.f3750a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f3755b};
        }

        public int hashCode() {
            Type type = this.f3756c;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f3755b.hashCode() + 31);
        }
        ...
        public String toString() {
            ...
            if (this.f3756c != null) {
                ...
                sb.append("? super ");
                type = this.f3756c;
            } else if (this.f3755b == Object.class) {
                return "?";
            } else {
                sb = new StringBuilder();
                sb.append("? extends ");
    ...
    public static Type b(Type type) {
        if (type instanceof Class) {
            ...
            return new C0107b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
    ...
    static void c(Type type) {
        d.a.b.w.a.a(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    public static Class<?> k(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            d.a.b.w.a.a(rawType instanceof Class);
    ...
    static Type l(Type type, Class<?> cls, Class<?> cls2) {
        ...
        d.a.b.w.a.a(cls2.isAssignableFrom(cls));
    ...
    public static ParameterizedType o(Type type, Type type2, Type... typeArr) {
        return new C0107b(type, type2, typeArr);
    }
    ...
    */
    private static java.lang.reflect.Type q(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10, java.util.Collection<java.lang.reflect.TypeVariable> r11) {
        ...
        Lbe:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: d.a.b.w.b.q(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static WildcardType s(Type type) {
        return new c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, f3750a);
    }
