...
public class e extends i0 {
    ...
    public e(Context context, AttributeSet attributeSet, int i) {
        ...
        this.u = true;
        this.v = false;
        TypedArray h2 = o.h(context, attributeSet, d.a.a.a.k.U0, i, 0, new int[0]);
        this.t = h2.getInt(d.a.a.a.k.W0, this.t);
        Drawable drawable = h2.getDrawable(d.a.a.a.k.V0);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.u = h2.getBoolean(d.a.a.a.k.X0, true);
        h2.recycle();
    }
