...
public class b extends ArrayAdapter<a> {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(R.layout.calorie_scope_news_inflate, (ViewGroup) null, true);
        }
        a item = getItem(i);
        w a2 = s.a(this.f1359b).a(item.b());
