...
public class IconCompat extends CustomVersionedParcelable {
    ...
    public int a() {
        if (this.f845a != -1 || Build.VERSION.SDK_INT < 23) {
            if (this.f845a == 2) {
                return this.e;
            }
            throw new IllegalStateException("called getResId() on " + this);
        }
        return a((Icon) this.f846b);
    }
    ...
    public void c() {
        ...
        if (i != -1) {
            if (i != 1) {
                ...
                this.f846b = new String(this.f847c, Charset.forName("UTF-16"));
                return;
            }
            parcelable = this.d;
            if (parcelable == null) {
