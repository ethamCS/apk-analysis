...
public final class i {
    ...
    public static class a implements ActionMode.Callback {
        ...
        /* renamed from: a */
        private final ActionMode.Callback f871a;

        /* renamed from: b */
        private final TextView f872b;
        ...
        private void a(Menu menu) {
            Context context = this.f872b.getContext();
            ...
            try {
                Method declaredMethod = (!this.e || !this.f873c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.d;
                ...
                for (int i = 0; i < a2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(a(resolveInfo, this.f872b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f871a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f871a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f871a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            a(menu);
            return this.f871a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static void a(TextView textView, a.g.j.c cVar) {
    ...
    public static c.a e(TextView textView) {
        ...
        c.a.C0012a c0012a = new c.a.C0012a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0012a.a(textView.getBreakStrategy());
            c0012a.b(textView.getHyphenationFrequency());
        }
        if (Build.VERSION.SDK_INT >= 18) {
            c0012a.a(d(textView));
        }
