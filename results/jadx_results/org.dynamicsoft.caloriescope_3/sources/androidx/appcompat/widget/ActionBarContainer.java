...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.d = findViewById(a.a.f.action_bar);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return this.f599b || super.onInterceptTouchEvent(motionEvent);
    }
    ...
    public void setStackedBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            if (this.j && (drawable2 = this.g) != null) {
                drawable2.setBounds(this.f600c.getLeft(), this.f600c.getTop(), this.f600c.getRight(), this.f600c.getBottom());
            }
        }
        boolean z = true;
        if (!this.i ? this.f != null || this.g != null : this.h != null) {
