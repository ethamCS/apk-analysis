...
public class b {
    ...
    /* renamed from: d */
    private static final Matrix f857d = new Matrix();

    /* renamed from: a */
    private final io.flutter.embedding.engine.renderer.a f858a;

    /* renamed from: b */
    private final l f859b = l.a();
    ...
    private void a(MotionEvent motionEvent, int i, int i2, int i3, Matrix matrix, ByteBuffer byteBuffer) {
        ...
        long d5 = this.f860c ? this.f859b.c(motionEvent).d() : 0L;
    ...
    public boolean d(MotionEvent motionEvent) {
        ...
        a(motionEvent, motionEvent.getActionIndex(), b2, 0, f857d, allocateDirect);
        if (allocateDirect.position() % 232 != 0) {
            throw new AssertionError("Packet position is not on field boundary.");
        }
        this.f858a.g(allocateDirect, allocateDirect.position());
        return true;
    }

    public boolean e(MotionEvent motionEvent) {
        return f(motionEvent, f857d);
    }
    ...
    */
    public boolean f(android.view.MotionEvent r13, android.graphics.Matrix r14) {
        ...
        L6f:
            ...
            int r13 = r13 % 232
            if (r13 != 0) goto L81
            io.flutter.embedding.engine.renderer.a r13 = r12.f858a
            int r14 = r1.position()
            r13.g(r1, r14)
            return r10
        L81:
