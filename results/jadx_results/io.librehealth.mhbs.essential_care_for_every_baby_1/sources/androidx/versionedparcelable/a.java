...
public abstract class a {
    ...
    /* renamed from: a */
    protected final b.b.a<String, Method> f301a;

    /* renamed from: b */
    protected final b.b.a<String, Method> f302b;

    /* renamed from: c */
    protected final b.b.a<String, Class> f303c;

    public a(b.b.a<String, Method> aVar, b.b.a<String, Method> aVar2, b.b.a<String, Class> aVar3) {
        this.f301a = aVar;
        this.f302b = aVar2;
        this.f303c = aVar3;
    }
    ...
    private Class c(Class<? extends c> cls) {
        Class cls2 = this.f303c.get(cls.getName());
        if (cls2 == null) {
            Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
            this.f303c.put(cls.getName(), cls3);
            return cls3;
        }
        return cls2;
    }
    ...
    private Method d(String str) {
        Method method = this.f301a.get(str);
        if (method == null) {
            System.currentTimeMillis();
            Method declaredMethod = Class.forName(str, true, a.class.getClassLoader()).getDeclaredMethod("read", a.class);
            this.f301a.put(str, declaredMethod);
    ...
    private Method e(Class cls) {
        Method method = this.f302b.get(cls.getName());
        if (method == null) {
            Class c2 = c(cls);
            System.currentTimeMillis();
            Method declaredMethod = c2.getDeclaredMethod("write", cls, a.class);
            this.f302b.put(cls.getName(), declaredMethod);
            return declaredMethod;
        }
        return method;
    }
