...
public final class b {
    ...
    /* renamed from: a */
    static final Type[] f466a = new Type[0];
    ...
    public static final class a implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return b.u(this.f467a) + "[]";
        }
    }

    /* renamed from: c.b.b.w.b$b */
    /* loaded from: classes.dex */
    public static final class C0027b implements ParameterizedType, Serializable {

        /* renamed from: a */
        private final Type f468a;

        /* renamed from: b */
        private final Type f469b;

        /* renamed from: c */
        private final Type[] f470c;

        public C0027b(Type type, Type type2, Type... typeArr) {
            ...
            this.f468a = type == null ? null : b.b(type);
            this.f469b = b.b(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f470c = typeArr2;
            int length = typeArr2.length;
            for (int i = 0; i < length; i++) {
                c.b.b.w.a.b(this.f470c[i]);
                b.c(this.f470c[i]);
                Type[] typeArr3 = this.f470c;
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f470c) ^ this.f469b.hashCode()) ^ b.m(this.f468a);
        }

        public String toString() {
            int length = this.f470c.length;
            if (length == 0) {
                return b.u(this.f469b);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.u(this.f469b));
            sb.append("<");
            sb.append(b.u(this.f470c[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ");
                sb.append(b.u(this.f470c[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: b */
        private final Type f472b;

        public c(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            c.b.b.w.a.a(typeArr2.length <= 1);
            c.b.b.w.a.a(typeArr.length == 1);
            if (typeArr2.length != 1) {
                c.b.b.w.a.b(typeArr[0]);
                b.c(typeArr[0]);
                this.f472b = null;
                this.f471a = b.b(typeArr[0]);
                return;
            }
            c.b.b.w.a.b(typeArr2[0]);
            b.c(typeArr2[0]);
            c.b.b.w.a.a(typeArr[0] != Object.class ? false : z);
            this.f472b = b.b(typeArr2[0]);
            this.f471a = Object.class;
        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f472b;
            return type != null ? new Type[]{type} : b.f466a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f471a};
        }

        public int hashCode() {
            Type type = this.f472b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f471a.hashCode() + 31);
        }
        ...
        public String toString() {
            ...
            if (this.f472b != null) {
                ...
                sb.append("? super ");
                type = this.f472b;
            } else if (this.f471a == Object.class) {
                return "?";
            } else {
                sb = new StringBuilder();
                sb.append("? extends ");
    ...
    public static Type b(Type type) {
        if (type instanceof Class) {
            ...
            return new C0027b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
    ...
    static void c(Type type) {
        c.b.b.w.a.a(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    public static Class<?> k(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            c.b.b.w.a.a(rawType instanceof Class);
    ...
    static Type l(Type type, Class<?> cls, Class<?> cls2) {
        ...
        c.b.b.w.a.a(cls2.isAssignableFrom(cls));
    ...
    public static ParameterizedType o(Type type, Type type2, Type... typeArr) {
        return new C0027b(type, type2, typeArr);
    }
    ...
    */
    private static java.lang.reflect.Type q(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10, java.util.Collection<java.lang.reflect.TypeVariable> r11) {
        ...
        Lc1:
            goto Lc0
        */
        throw new UnsupportedOperationException("Method not decompiled: c.b.b.w.b.q(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static WildcardType s(Type type) {
        return new c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, f466a);
    }
