...
public final class OpenSSLRSAKeyFactory extends KeyFactorySpi {
    ...
    protected <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> cls) {
        if (key != null) {
            ...
            if (z11 && RSAPrivateCrtKeySpec.class.isAssignableFrom(cls)) {
            ...
            } else if (z11 && RSAPrivateKeySpec.class.isAssignableFrom(cls)) {
                ...
                } else if (z12 && RSAPrivateKeySpec.class.isAssignableFrom(cls)) {
                ...
                } else if (z12 && PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                ...
                } else if (!z10 || !X509EncodedKeySpec.class.isAssignableFrom(cls)) {
