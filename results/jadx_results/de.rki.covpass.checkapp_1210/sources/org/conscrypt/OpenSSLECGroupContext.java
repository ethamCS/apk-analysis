...
public final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) {
        ...
        try {
            long EC_GROUP_new_arbitrary = NativeCrypto.EC_GROUP_new_arbitrary(p10.toByteArray(), a10.toByteArray(), b10.toByteArray(), affineX.toByteArray(), affineY.toByteArray(), order.toByteArray(), eCParameterSpec.getCofactor());
