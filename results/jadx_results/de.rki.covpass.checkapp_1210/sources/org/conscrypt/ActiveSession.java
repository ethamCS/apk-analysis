...
public final class ActiveSession implements ConscryptSession {
    ...
    @Override // javax.net.ssl.SSLSession
    public byte[] getId() {
        if (this.f18703id == null) {
            synchronized (this.ssl) {
                this.f18703id = this.ssl.getSessionId();
            }
        }
        byte[] bArr = this.f18703id;
    ...
    public void onPeerCertificateAvailable(String str, int i10) {
        synchronized (this.ssl) {
            this.f18703id = null;
            if (this.localCertificates == null) {
                this.localCertificates = this.ssl.getLocalCertificates();
