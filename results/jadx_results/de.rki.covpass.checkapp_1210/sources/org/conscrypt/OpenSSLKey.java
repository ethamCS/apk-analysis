...
public final class OpenSSLKey {
    ...
    public static PrivateKey getPrivateKey(PKCS8EncodedKeySpec pKCS8EncodedKeySpec, int i10) {
        try {
    ...
    public static PublicKey getPublicKey(X509EncodedKeySpec x509EncodedKeySpec, int i10) {
        try {
