...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f18700c.equals(((X509CRLEntryObject) obj).f18700c) : super.equals(this);
    }
    ...
    public Date getRevocationDate() {
        return this.f18700c.n().l();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f18700c.o().G();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f18700c.l() != null;
    }
                    ...
                    while (true) {
                        ...
                        while (o10.hasMoreElements()) {
                            ...
                            if (l11.n() != null) {
                                ...
                                stringBuffer.append(") ");
                                try {
                                    if (vVar.s(w0.f12090k)) {
                                        n10 = m.l(i.E(pVar.s()));
                                    } else if (vVar.s(w0.f12095p)) {
