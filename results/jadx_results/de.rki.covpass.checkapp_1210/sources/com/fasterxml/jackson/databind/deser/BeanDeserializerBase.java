...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer {
    ...
    public BeanDeserializerBase(BeanDeserializerBase beanDeserializerBase, NameTransformer nameTransformer) {
        ...
        if (nameTransformer != null) {
            ...
            beanPropertyMap = beanDeserializerBase._beanProperties.renameAll(nameTransformer);
        } else {
    ...
    public BeanDeserializerBase(BeanDeserializerBuilder beanDeserializerBuilder, BeanDescription beanDescription, BeanPropertyMap beanPropertyMap, Map<String, SettableBeanProperty> map, Set<String> set, boolean z10, Set<String> set2, boolean z11) {
    ...
    protected BeanDeserializerBase _handleByNameInclusion(DeserializationContext deserializationContext, AnnotationIntrospector annotationIntrospector, BeanDeserializerBase beanDeserializerBase, AnnotatedMember annotatedMember) {
    ...
    public void resolve(DeserializationContext deserializationContext) {
        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            ...
            if (this._ignorableProps != null || this._includableProps != null) {
                int length = settableBeanPropertyArr.length;
                for (int i10 = 0; i10 < length; i10++) {
                    if (IgnorePropertiesUtil.shouldIgnore(settableBeanPropertyArr[i10].getName(), this._ignorableProps, this._includableProps)) {
                        settableBeanPropertyArr[i10].markAsIgnorable();
                    }
                }
            }
        } else {
    ...
    public abstract BeanDeserializerBase withIgnoreAllUnknown(boolean z10);
