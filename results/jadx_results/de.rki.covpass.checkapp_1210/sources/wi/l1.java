...
public class l1 extends i.b {
    public l1(ti.e eVar, ti.f fVar, ti.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public l1(ti.e eVar, ti.f fVar, ti.f fVar2, ti.f[] fVarArr) {
    ...
    public ti.i J() {
        ...
        return new l1(i10, o11, fVar.p(a10, j10).a(o11).a(j11), new ti.f[]{j11});
    }
    ...
    public ti.i K(ti.i iVar) {
        ...
        if (o14.i()) {
            ...
            return new l1(i10, l10, i10.o().n());
        } else {
            ti.f j11 = l10.o().j(j10);
            ti.f j12 = l10.j(o14).j(o13);
            return new l1(i10, j11, l10.a(o14).o().l(a10, b10, j12), new ti.f[]{j12});
        }
    }
    ...
    public ti.i a(ti.i iVar) {
        ...
        if (n10.i()) {
            ...
            if (fVar5.i()) {
                return new l1(i10, fVar5, i10.o().n());
            }
        ...
        return new l1(i10, fVar5, fVar4, new ti.f[]{fVar6});
    }
    ...
    public ti.i z() {
        ...
        ti.f fVar2 = this.f22405c;
        ti.f fVar3 = this.f22406d[0];
        return new l1(this.f22403a, fVar, fVar2.a(fVar3), new ti.f[]{fVar3});
    }
}
