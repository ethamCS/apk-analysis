...
public class i2 extends e.b {
    ...
    /* renamed from: k */
    private static final ti.f[] f25176k = {new f2(ti.d.f22360b)};

    /* renamed from: j */
    protected j2 f25177j = new j2(this, null, null);
    ...
    class a extends ti.a {
        ...
        private ti.i d(long[] jArr, long[] jArr2) {
            return i2.this.i(new f2(jArr), new f2(jArr2), i2.f25176k);
        }
        ...
        public ti.i a(int i10) {
            ...
            long[] c11 = bj.i.c();
            int i11 = 0;
            for (int i12 = 0; i12 < this.f25178a; i12++) {
                long j10 = ((i12 ^ i10) - 1) >> 31;
                for (int i13 = 0; i13 < 5; i13++) {
                    long j11 = c10[i13];
                    long[] jArr = this.f25179b;
    ...
    public i2() {
        ...
        this.f22367c = m(new BigInteger(1, bk.f.b("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
        this.f22368d = new BigInteger(1, bk.f.b("03FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF90399660FC938A90165B042A7CEFADB307"));
