...
public class n2 extends i.b {
    public n2(ti.e eVar, ti.f fVar, ti.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public n2(ti.e eVar, ti.f fVar, ti.f fVar2, ti.f[] fVarArr) {
    ...
    public ti.i J() {
        ...
        return new n2(i10, o11, o12.a(a10).a(o10).j(o12).a(fVar3).a(o11).a(j10), new ti.f[]{j10});
    }
    ...
    public ti.i K(ti.i iVar) {
        ...
        if (o14.i()) {
            ...
            return new n2(i10, l10, i10.o());
        } else {
            ti.f j11 = l10.o().j(j10);
            ti.f j12 = l10.j(o14).j(o13);
            return new n2(i10, j11, l10.a(o14).o().l(a10, b10, j12), new ti.f[]{j12});
        }
    }
    ...
    public ti.i a(ti.i iVar) {
        ...
        return new n2(i10, fVar5, fVar4, new ti.f[]{fVar6});
    }
    ...
    public ti.i z() {
        ...
        ti.f fVar2 = this.f22405c;
        ti.f fVar3 = this.f22406d[0];
        return new n2(this.f22403a, fVar, fVar2.a(fVar3), new ti.f[]{fVar3});
    }
}
