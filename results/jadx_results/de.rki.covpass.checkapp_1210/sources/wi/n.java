...
public class n extends i.c {
    public n(ti.e eVar, ti.f fVar, ti.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public n(ti.e eVar, ti.f fVar, ti.f fVar2, ti.f[] fVarArr) {
    ...
    public ti.i J() {
        ...
        int[] d11 = bj.e.d();
        int[] d12 = bj.e.d();
        l.m(mVar.f25201g, d12);
        int[] d13 = bj.e.d();
        l.m(d12, d13);
        boolean h10 = mVar3.h();
        int[] iArr = mVar3.f25201g;
        if (!h10) {
            l.m(iArr, d11);
            iArr = d11;
        }
        l.o(mVar2.f25201g, iArr, d10);
        l.a(mVar2.f25201g, iArr, d11);
        l.f(d11, d10, d11);
        l.l(bj.e.b(d11, d11, d11), d11);
        l.f(d12, mVar2.f25201g, d12);
        l.l(bj.n.M(5, d12, 2, 0), d12);
        l.l(bj.n.N(5, d13, 3, 0, d10), d10);
        m mVar4 = new m(d13);
        l.m(d11, mVar4.f25201g);
        int[] iArr2 = mVar4.f25201g;
        l.o(iArr2, d12, iArr2);
        int[] iArr3 = mVar4.f25201g;
        l.o(iArr3, d12, iArr3);
        m mVar5 = new m(d12);
        l.o(d12, mVar4.f25201g, mVar5.f25201g);
        int[] iArr4 = mVar5.f25201g;
        l.f(iArr4, d11, iArr4);
        int[] iArr5 = mVar5.f25201g;
        l.o(iArr5, d10, iArr5);
        m mVar6 = new m(d11);
        l.p(mVar.f25201g, mVar6.f25201g);
        if (!h10) {
            int[] iArr6 = mVar6.f25201g;
            l.f(iArr6, mVar3.f25201g, iArr6);
        }
        return new n(i10, mVar4, mVar5, new ti.f[]{mVar6});
    }
    ...
    public ti.i a(ti.i iVar) {
        ...
        return new n(i10, mVar7, mVar8, new ti.f[]{mVar9});
    }
    ...
    @Override // ti.i
    public ti.i z() {
        return u() ? this : new n(this.f22403a, this.f22404b, this.f22405c.m(), this.f22406d);
    }
}
