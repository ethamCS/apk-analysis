...
public class j1 extends i.b {
    public j1(ti.e eVar, ti.f fVar, ti.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public j1(ti.e eVar, ti.f fVar, ti.f fVar2, ti.f[] fVarArr) {
    ...
    public ti.i J() {
        ...
        ti.f a10 = fVar2.o().a(j10).a(fVar3);
        if (a10.i()) {
            return new j1(i10, a10, i10.o());
        }
        ti.f o10 = a10.o();
        ti.f j11 = h10 ? a10 : a10.j(fVar3);
        ti.f o11 = fVar2.a(fVar).o();
        return new j1(i10, o10, o11.a(a10).a(fVar3).j(o11).a(o10), new ti.f[]{j11});
    }
    ...
    public ti.i K(ti.i iVar) {
        ...
        ti.f o12 = fVar2.o();
        ti.f o13 = fVar3.o();
        ti.f a10 = o13.a(o12).a(fVar2.j(fVar3));
        ti.f l10 = o10.j(o13).a(o12).l(a10, o11, o13);
        ti.f j10 = n10.j(o13);
        ti.f o14 = j10.a(a10).o();
        if (o14.i()) {
            return l10.i() ? iVar.J() : i10.u();
        } else if (l10.i()) {
            return new j1(i10, l10, i10.o());
        } else {
            ti.f j11 = l10.o().j(j10);
            ti.f j12 = l10.j(o14).j(o13);
            return new j1(i10, j11, l10.a(o14).o().l(a10, o10.b(), j12), new ti.f[]{j12});
        }
    }
    ...
    public ti.i a(ti.i iVar) {
        ...
        if (n10.i()) {
            ...
            fVar5 = d10.o().a(d10).a(q10).b();
            if (fVar5.i()) {
                return new j1(i10, fVar5, i10.o());
            }
        ...
        return new j1(i10, fVar5, fVar4, new ti.f[]{fVar6});
    }
    ...
    public ti.i z() {
        ...
        ti.f fVar2 = this.f22405c;
        ti.f fVar3 = this.f22406d[0];
        return new j1(this.f22403a, fVar, fVar2.a(fVar3), new ti.f[]{fVar3});
    }
}
