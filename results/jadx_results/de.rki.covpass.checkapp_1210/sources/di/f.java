...
public class f implements org.bouncycastle.crypto.n {
    ...
    public BigInteger[] a(byte[] bArr) {
        ...
        BigInteger c10 = ((d0) this.f9093g).c();
        ti.h c11 = c();
        while (true) {
            BigInteger e11 = ak.b.e(e10.bitLength(), this.f9094h);
    ...
    public boolean b(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger e10 = this.f9093g.b().e();
        ...
        ti.i A = ti.c.r(this.f9093g.b().b(), bigInteger2.multiply(k10).mod(e10), ((e0) this.f9093g).c(), e10.subtract(bigInteger).multiply(k10).mod(e10)).A();
        if (!A.u()) {
    ...
    public void init(boolean z10, org.bouncycastle.crypto.i iVar) {
        ...
        if (!z10) {
            ...
            g1 g1Var = (g1) iVar;
            this.f9094h = g1Var.b();
            this.f9093g = (d0) g1Var.a();
            return;
        } else {
            this.f9094h = org.bouncycastle.crypto.l.b();
            b0Var = (d0) iVar;
        }
        this.f9093g = b0Var;
    }
