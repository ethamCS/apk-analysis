...
public final class a extends m7.j {
    ...
    /* renamed from: y */
    private final ZonedDateTime f11418y;
    ...
    public static final class C0169a implements Parcelable.Creator<a> {
        ...
        public final a createFromParcel(Parcel parcel) {
            ...
            return new a(parcel.readString(), parcel.readString(), parcel.readString(), (ZonedDateTime) parcel.readSerializable(), (ExpertModeData) parcel.readParcelable(a.class.getClassLoader()), parcel.readInt() != 0);
        }
    ...
    public a(String str, String str2, String str3, ZonedDateTime zonedDateTime, ExpertModeData expertModeData, boolean z10) {
        super(k0.b(b.class));
        hc.t.e(str, "name");
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeString(this.f11416q);
        parcel.writeString(this.f11417x);
        parcel.writeSerializable(this.f11418y);
