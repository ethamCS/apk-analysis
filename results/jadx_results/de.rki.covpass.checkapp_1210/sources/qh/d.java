...
public class d implements org.bouncycastle.crypto.e {
    ...
    protected static byte f(byte b10) {
        return f19960c[b10 & 255];
    }

    protected static byte g(byte b10) {
        return f19961d[b10 & 255];
    }

    protected static byte h(byte b10) {
        return f19962e[b10 & 255];
    }

    protected static byte i(byte b10) {
        return f19963f[b10 & 255];
    }
    ...
    protected static byte[][] l(boolean z10, byte[] bArr) {
        ...
        o(bArr11, bArr9);
        int i11 = (i10 * 2) + 12;
        byte[][] bArr12 = (byte[][]) Array.newInstance(byte.class, i11 + 1, 16);
    ...
    protected static void m(byte[] bArr, byte[] bArr2, byte[] bArr3, int i10) {
        int i11 = i10 >>> 3;
        int i12 = i10 & 7;
        int i13 = 8 - i12;
    ...
    public int a(byte[] bArr, int i10, byte[] bArr2, int i11) {
        if (this.f19964a != null) {
            ...
            int length = this.f19964a.length - 3;
            int i12 = 0;
            while (i12 < length) {
                int i13 = i12 + 1;
                e(bArr3, this.f19964a[i12]);
                d(bArr3, this.f19964a[i13]);
                i12 = i13 + 1;
            }
            int i14 = i12 + 1;
            e(bArr3, this.f19964a[i12]);
            o(bArr3, this.f19964a[i14]);
            k(bArr3);
            o(bArr3, this.f19964a[i14 + 1]);
    ...
    public void init(boolean z10, org.bouncycastle.crypto.i iVar) {
        if (iVar instanceof zh.b1) {
            this.f19964a = l(z10, ((zh.b1) iVar).a());
            return;
        }
