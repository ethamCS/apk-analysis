...
public class j implements org.bouncycastle.crypto.e {
    ...
    /* renamed from: c */
    private int[] f20048c = new int[96];

    /* renamed from: d */
    private int[] f20049d = new int[8];

    /* renamed from: e */
    private int[] f20050e = new int[12];

    /* renamed from: f */
    private int[] f20051f = new int[4];
    ...
    private void d(int[] iArr, int[] iArr2, int i10) {
        ...
        iArr[0] = iArr[0] ^ i21;
        iArr[1] = (i21 ^ l(i19, 8)) ^ iArr[1];
    }

    private void e(int[] iArr, int[] iArr2, int i10) {
        iArr[1] = iArr[1] ^ i(iArr[0] & iArr2[i10 + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i10 + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i10 + 3] | iArr[3]);
        iArr[3] = i(iArr2[i10 + 2] & iArr[2], 1) ^ iArr[3];
    }

    private static void f(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 2;
        int i14 = i11 + 0;
        int i15 = i11 + 1;
        int i16 = 32 - i10;
    ...
    private static void g(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 2;
        int i14 = i11 + 1;
        int i15 = i10 - 32;
        int i16 = i11 + 2;
    ...
    private int j(byte[] bArr, int i10, byte[] bArr2, int i11) {
        for (int i12 = 0; i12 < 4; i12++) {
            this.f20051f[i12] = c(bArr, (i12 * 4) + i10);
            int[] iArr = this.f20051f;
            iArr[i12] = iArr[i12] ^ this.f20049d[i12];
        }
        d(this.f20051f, this.f20048c, 0);
        d(this.f20051f, this.f20048c, 4);
        d(this.f20051f, this.f20048c, 8);
        e(this.f20051f, this.f20050e, 0);
        d(this.f20051f, this.f20048c, 12);
        d(this.f20051f, this.f20048c, 16);
        d(this.f20051f, this.f20048c, 20);
        e(this.f20051f, this.f20050e, 4);
        d(this.f20051f, this.f20048c, 24);
        d(this.f20051f, this.f20048c, 28);
        d(this.f20051f, this.f20048c, 32);
        int[] iArr2 = this.f20051f;
        int i13 = iArr2[2];
        int[] iArr3 = this.f20049d;
        iArr2[2] = iArr3[4] ^ i13;
        iArr2[3] = iArr2[3] ^ iArr3[5];
        iArr2[0] = iArr2[0] ^ iArr3[6];
        iArr2[1] = iArr3[7] ^ iArr2[1];
        h(iArr2[2], bArr2, i11);
        h(this.f20051f[3], bArr2, i11 + 4);
        h(this.f20051f[0], bArr2, i11 + 8);
        h(this.f20051f[1], bArr2, i11 + 12);
        return 16;
    }

    private int k(byte[] bArr, int i10, byte[] bArr2, int i11) {
        for (int i12 = 0; i12 < 4; i12++) {
            this.f20051f[i12] = c(bArr, (i12 * 4) + i10);
            int[] iArr = this.f20051f;
            iArr[i12] = iArr[i12] ^ this.f20049d[i12];
        ...
        d(this.f20051f, this.f20048c, 28);
        d(this.f20051f, this.f20048c, 32);
        e(this.f20051f, this.f20050e, 8);
        d(this.f20051f, this.f20048c, 36);
        d(this.f20051f, this.f20048c, 40);
        d(this.f20051f, this.f20048c, 44);
        int[] iArr2 = this.f20051f;
        int i13 = iArr2[2];
        int[] iArr3 = this.f20049d;
        iArr2[2] = i13 ^ iArr3[4];
    ...
    private static void m(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 0;
        int i14 = i11 + 0;
        int i15 = i11 + 1;
        int i16 = 32 - i10;
    ...
    private static void n(int i10, int[] iArr, int i11, int[] iArr2, int i12) {
        int i13 = i12 + 0;
        int i14 = i11 + 1;
        int i15 = i10 - 32;
        int i16 = i11 + 2;
    ...
    private void o(boolean z10, byte[] bArr) {
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        int[] iArr4 = new int[4];
        ...
        d(iArr2, f20041g, 4);
        if (this.f20047b) {
            int[] iArr5 = this.f20049d;
            if (z10) {
                iArr5[0] = iArr[0];
                iArr5[1] = iArr[1];
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                m(15, iArr, 0, this.f20048c, 4);
                m(30, iArr, 0, this.f20048c, 12);
                m(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.f20048c;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                m(17, iArr, 0, this.f20050e, 4);
                m(17, iArr, 0, this.f20048c, 24);
                m(17, iArr, 0, this.f20048c, 32);
                int[] iArr7 = this.f20048c;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                m(15, iArr2, 0, iArr7, 8);
                m(15, iArr2, 0, this.f20050e, 0);
                m(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.f20048c;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                m(15, iArr2, 0, iArr8, 20);
                n(34, iArr2, 0, this.f20048c, 28);
                m(17, iArr2, 0, this.f20049d, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            f(15, iArr, 0, this.f20048c, 28);
            f(30, iArr, 0, this.f20048c, 20);
            f(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.f20048c;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            f(17, iArr, 0, this.f20050e, 0);
            f(17, iArr, 0, this.f20048c, 8);
            f(17, iArr, 0, this.f20048c, 0);
            int[] iArr10 = this.f20048c;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            f(15, iArr2, 0, iArr10, 24);
            f(15, iArr2, 0, this.f20050e, 4);
            f(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.f20048c;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            f(15, iArr2, 0, iArr11, 12);
            g(34, iArr2, 0, this.f20048c, 4);
            m(17, iArr2, 0, this.f20049d, 0);
            return;
        }
        for (int i12 = 0; i12 < 4; i12++) {
        ...
        d(iArr3, f20041g, 8);
        int[] iArr12 = this.f20049d;
        if (z10) {
            iArr12[0] = iArr[0];
            iArr12[1] = iArr[1];
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            n(45, iArr, 0, this.f20048c, 16);
            m(15, iArr, 0, this.f20050e, 4);
            m(17, iArr, 0, this.f20048c, 32);
            n(34, iArr, 0, this.f20048c, 44);
            m(15, iArr, 4, this.f20048c, 4);
            m(15, iArr, 4, this.f20050e, 0);
            m(30, iArr, 4, this.f20048c, 24);
            n(34, iArr, 4, this.f20048c, 36);
            m(15, iArr2, 0, this.f20048c, 8);
            m(30, iArr2, 0, this.f20048c, 20);
            int[] iArr13 = this.f20050e;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            n(49, iArr2, 0, this.f20048c, 40);
            int[] iArr14 = this.f20048c;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            m(30, iArr3, 0, iArr14, 12);
            m(30, iArr3, 0, this.f20048c, 28);
            n(51, iArr3, 0, this.f20049d, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        g(45, iArr, 0, this.f20048c, 28);
        f(15, iArr, 0, this.f20050e, 4);
        f(17, iArr, 0, this.f20048c, 12);
        g(34, iArr, 0, this.f20048c, 0);
        f(15, iArr, 4, this.f20048c, 40);
        f(15, iArr, 4, this.f20050e, 8);
        f(30, iArr, 4, this.f20048c, 20);
        g(34, iArr, 4, this.f20048c, 8);
        f(15, iArr2, 0, this.f20048c, 36);
        f(30, iArr2, 0, this.f20048c, 24);
        int[] iArr15 = this.f20050e;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        g(49, iArr2, 0, this.f20048c, 4);
        int[] iArr16 = this.f20048c;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        f(30, iArr3, 0, iArr16, 32);
        f(30, iArr3, 0, this.f20048c, 16);
        n(51, iArr3, 0, this.f20049d, 0);
    }
    ...
    public int a(byte[] bArr, int i10, byte[] bArr2, int i11) {
        if (this.f20046a) {
            ...
            return this.f20047b ? j(bArr, i10, bArr2, i11) : k(bArr, i10, bArr2, i11);
        }
