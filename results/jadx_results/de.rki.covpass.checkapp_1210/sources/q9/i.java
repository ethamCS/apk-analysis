...
import tb.t;
import zb.l;
@Metadata(bv = {}, d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u001e\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0019\u001a\u00020\u0018¢\u0006\u0004\b\u001a\u0010\u001bJ/\u0010\t\u001a\u00020\b2\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00022\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005H\u0086@ø\u0001\u0000¢\u0006\u0004\b\t\u0010\nJ\u0019\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0005H\u0086@ø\u0001\u0000¢\u0006\u0004\b\f\u0010\rJ9\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\u0006\u0010\u000e\u001a\u00020\u00032\u0006\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\u00112\u0006\u0010\u0014\u001a\u00020\u0013H\u0086@ø\u0001\u0000¢\u0006\u0004\b\u0015\u0010\u0016J\u0013\u0010\u0017\u001a\u00020\bH\u0086@ø\u0001\u0000¢\u0006\u0004\b\u0017\u0010\r\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u001c"}, d2 = {"Lq9/i;", BuildConfig.FLAVOR, BuildConfig.FLAVOR, BuildConfig.FLAVOR, "keep", BuildConfig.FLAVOR, "Lj9/d;", "add", "Ltb/e0;", "e", "(Ljava/util/Collection;Ljava/util/List;Lxb/d;)Ljava/lang/Object;", "Lq9/b;", "c", "(Lxb/d;)Ljava/lang/Object;", "countryIsoCode", "j$/time/ZonedDateTime", "validationClock", "Ldgca/verifier/app/engine/data/Type;", "type", "Ldgca/verifier/app/engine/data/RuleCertificateType;", "ruleCertificateType", "d", "(Ljava/lang/String;Lj$/time/ZonedDateTime;Ldgca/verifier/app/engine/data/Type;Ldgca/verifier/app/engine/data/RuleCertificateType;Lxb/d;)Ljava/lang/Object;", "b", "Lq9/e;", "covPassDomesticRulesDao", "<init>", "(Lq9/e;)V", "covpass-sdk_release"}, k = 1, mv = {1, 7, 1})
...
public final class i {
    ...
    @zb.f(c = "de.rki.covpass.sdk.rules.local.rules.domestic.CovPassDomesticRulesLocalDataSource$deleteAll$2", f = "CovPassDomesticRulesLocalDataSource.kt", l = {51}, m = "invokeSuspend")
    /* loaded from: classes.dex */
    public static final class a extends l implements p<q0, xb.d<? super e0>, Object> {
        ...
        public final Object B(Object obj) {
            Object c10;
            c10 = yb.d.c();
            int i10 = this.f19751y;
            if (i10 == 0) {
                t.b(obj);
                e eVar = i.this.f19750a;
                this.f19751y = 1;
    ...
    @Metadata(bv = {}, d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/q0;", BuildConfig.FLAVOR, "Lq9/b;", "<anonymous>"}, k = 3, mv = {1, 7, 1})
    @zb.f(c = "de.rki.covpass.sdk.rules.local.rules.domestic.CovPassDomesticRulesLocalDataSource$getAllRules$2", f = "CovPassDomesticRulesLocalDataSource.kt", l = {31}, m = "invokeSuspend")
    /* loaded from: classes.dex */
    public static final class b extends l implements p<q0, xb.d<? super List<? extends q9.b>>, Object> {
        ...
        /* renamed from: d0 */
        public final Object u(q0 q0Var, xb.d<? super List<q9.b>> dVar) {
    ...
    @zb.f(c = "de.rki.covpass.sdk.rules.local.rules.domestic.CovPassDomesticRulesLocalDataSource$getRulesBy$2", f = "CovPassDomesticRulesLocalDataSource.kt", l = {}, m = "invokeSuspend")
    /* loaded from: classes.dex */
    public static final class c extends l implements p<q0, xb.d<? super List<? extends j9.d>>, Object> {
        ...
        public final Object B(Object obj) {
            ...
            if (this.f19753y == 0) {
                t.b(obj);
                return q9.c.f(i.this.f19750a.d(this.V3, this.W3, this.X3, this.Y3, RuleCertificateType.GENERAL));
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    @Metadata(bv = {}, d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/q0;", "Ltb/e0;", "<anonymous>"}, k = 3, mv = {1, 7, 1})
    @zb.f(c = "de.rki.covpass.sdk.rules.local.rules.domestic.CovPassDomesticRulesLocalDataSource$replaceRules$2", f = "CovPassDomesticRulesLocalDataSource.kt", l = {22}, m = "invokeSuspend")
    /* loaded from: classes.dex */
    public static final class d extends l implements p<q0, xb.d<? super e0>, Object> {
        ...
        public final Object B(Object obj) {
            Object c10;
            c10 = yb.d.c();
            int i10 = this.f19754y;
            if (i10 == 0) {
                t.b(obj);
                e eVar = i.this.f19750a;
                Collection<String> collection = this.V3;
                List<q9.d> d10 = q9.c.d(this.W3);
                this.f19754y = 1;
                if (eVar.i(collection, d10, this) == c10) {
                    return c10;
                }
            } else if (i10 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public i(e eVar) {
        hc.t.e(eVar, "covPassDomesticRulesDao");
        this.f19750a = eVar;
    }
    ...
    public final Object c(xb.d<? super List<q9.b>> dVar) {
