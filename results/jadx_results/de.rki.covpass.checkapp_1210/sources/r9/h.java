...
public final class h extends r9.e {
    ...
    /* renamed from: a */
    private final i0 f20536a;

    /* renamed from: b */
    private final h1.g<r9.b> f20537b;

    /* renamed from: c */
    private final o9.a f20538c = new o9.a();

    /* renamed from: d */
    private final h1.g<r9.a> f20539d;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public class a extends h1.g<r9.b> {
        ...
        public void g(k kVar, r9.b bVar) {
            ...
            kVar.A0(9, h.this.f20538c.f(bVar.m()));
            kVar.A0(10, h.this.f20538c.f(bVar.n()));
            String a10 = h.this.f20538c.a(bVar.a());
            if (a10 == null) {
                kVar.a0(11);
            } else {
                kVar.K(11, a10);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public class b extends h1.g<r9.a> {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(i0 i0Var) {
            super(i0Var);
            h.this = r1;
        ...
        /* renamed from: k */
        public void g(k kVar, r9.a aVar) {
            kVar.A0(1, aVar.d());
            kVar.A0(2, aVar.f());
            if (aVar.e() == null) {
                kVar.a0(3);
    ...
    class c implements Callable<Long> {
        ...
        public Long call() {
            h.this.f20536a.e();
            try {
                long j10 = h.this.f20537b.j(this.f20542a);
                h.this.f20536a.D();
    ...
    class d implements Callable<e0> {
        ...
        /* renamed from: a */
        final /* synthetic */ r9.a[] f20544a;

        d(r9.a[] aVarArr) {
            h.this = r1;
            this.f20544a = aVarArr;
        }
    ...
    /* loaded from: classes.dex */
    class e implements Callable<List<r9.b>> {
        ...
        public List<r9.b> call() {
            ...
            int i12;
            String str4;
            Cursor c10 = j1.c.c(h.this.f20536a, this.f20546a, false, null);
            try {
                ...
                while (c10.moveToNext()) {
                    ...
                    ZonedDateTime c11 = h.this.f20538c.c(Long.valueOf(c10.getLong(e18)));
                    ZonedDateTime c12 = h.this.f20538c.c(Long.valueOf(c10.getLong(e19)));
                    List<String> b10 = h.this.f20538c.b(c10.isNull(e20) ? null : c10.getString(e20));
                    if (c10.isNull(e21)) {
                        i10 = i13;
                        str = null;
                    } else {
                    ...
                    arrayList.add(new r9.b(j10, string, x10, string2, string3, string4, string5, v10, c11, c12, b10, str, str2, str3, str4));
                    e23 = i11;
                    e10 = i14;
                }
                return arrayList;
    ...
    class f implements Callable<e0> {
        ...
        /* renamed from: a */
        final /* synthetic */ Collection f20548a;

        f(Collection collection) {
            h.this = r1;
            this.f20548a = collection;
        }
        ...
        public e0 call() {
            ...
            j1.f.a(b10, this.f20548a.size());
            b10.append(")");
            k f10 = h.this.f20536a.f(b10.toString());
            int i10 = 1;
    ...
    public static /* synthetic */ class g {
        ...
        /* renamed from: b */
        static final /* synthetic */ int[] f20551b;
        ...
        static {
            ...
            try {
                f20551b[RuleCertificateType.TEST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20551b[RuleCertificateType.VACCINATION.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20551b[RuleCertificateType.RECOVERY.ordinal()] = 4;
            ...
            try {
                f20550a[Type.ACCEPTANCE.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f20550a[Type.TWOG.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f20550a[Type.TWOGPLUS.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f20550a[Type.THREEG.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f20550a[Type.THREEGPLUS.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f20550a[Type.MASK.ordinal()] = 7;
    ...
    public h(i0 i0Var) {
        this.f20536a = i0Var;
        this.f20537b = new a(i0Var);
        this.f20539d = new b(i0Var);
    }
    ...
    public /* synthetic */ Object C(r9.d[] dVarArr, xb.d dVar) {
    ...
    public String u(RuleCertificateType ruleCertificateType) {
        ...
        int i10 = g.f20551b[ruleCertificateType.ordinal()];
        if (i10 == 1) {
            return "GENERAL";
        }
        if (i10 == 2) {
    ...
    private void y(i0.d<ArrayList<r9.a>> dVar) {
        if (dVar.j()) {
            return;
        }
        if (dVar.p() > 999) {
            i0.d<ArrayList<r9.a>> dVar2 = new i0.d<>(999);
            int p10 = dVar.p();
            int i10 = 0;
            int i11 = 0;
            while (i10 < p10) {
        ...
        Cursor c10 = j1.c.c(this.f20536a, f10, false, null);
        try {
            ...
            while (c10.moveToNext()) {
                ArrayList<r9.a> g10 = dVar.g(c10.getLong(d10));
                if (g10 != null) {
                    g10.add(new r9.a(c10.getLong(0), c10.getLong(1), c10.isNull(2) ? null : c10.getString(2), c10.isNull(3) ? null : c10.getString(3)));
                }
            }
        } finally {
            c10.close();
    ...
    public Object a(Collection<String> collection, xb.d<? super e0> dVar) {
        return h1.f.b(this.f20536a, true, new f(collection), dVar);
    }

    @Override // r9.e
    public Object c(xb.d<? super List<r9.b>> dVar) {
        l f10 = l.f("SELECT * from covpass_rules", 0);
        return h1.f.a(this.f20536a, false, j1.c.a(), new e(f10), dVar);
    }
    ...
    */
    public java.util.List<r9.d> d(java.lang.String r38, j$.time.ZonedDateTime r39, dgca.verifier.app.engine.data.Type r40, dgca.verifier.app.engine.data.RuleCertificateType r41, dgca.verifier.app.engine.data.RuleCertificateType r42) {
        /*
            Method dump skipped, instructions count: 713
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: r9.h.d(java.lang.String, j$.time.ZonedDateTime, dgca.verifier.app.engine.data.Type, dgca.verifier.app.engine.data.RuleCertificateType, dgca.verifier.app.engine.data.RuleCertificateType):java.util.List");
    }

    @Override // r9.e
    public Object e(final r9.d[] dVarArr, xb.d<? super e0> dVar) {
        return j0.d(this.f20536a, new gc.l() { // from class: r9.g
            @Override // gc.l
    ...
    @Override // r9.e
    public Object g(r9.a[] aVarArr, xb.d<? super e0> dVar) {
        return h1.f.b(this.f20536a, true, new d(aVarArr), dVar);
    }

    @Override // r9.e
    public Object h(r9.b bVar, xb.d<? super Long> dVar) {
        return h1.f.b(this.f20536a, true, new c(bVar), dVar);
    }

    @Override // r9.e
    public Object i(final Collection<String> collection, final Collection<r9.d> collection2, xb.d<? super e0> dVar) {
        return j0.d(this.f20536a, new gc.l() { // from class: r9.f
            @Override // gc.l
            public final Object invoke(Object obj) {
                Object D;
