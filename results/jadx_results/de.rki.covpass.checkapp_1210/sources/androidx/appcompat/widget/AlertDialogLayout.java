...
public class AlertDialogLayout extends l0 {
    ...
    private static int B(View view) {
        int C = androidx.core.view.y.C(view);
        if (C > 0) {
            return C;
        }
    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == e.f.P_res_0x7f090283) {
                    view = childAt;
                } else if (id2 == e.f.k_res_0x7f090075) {
                    view2 = childAt;
                } else if ((id2 != e.f.m_res_0x7f0900ad && id2 != e.f.o_res_0x7f0900b6) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = androidx.core.view.y.B(r17)
