...
public class d {
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f3459a = bVar.f3459a;
            float[] fArr = bVar.f3460b;
            this.f3460b = d.c(fArr, 0, fArr.length);
        }
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                a(path, fArr, c10, bVarArr[i10].f3459a, bVarArr[i10].f3460b);
                c10 = bVarArr[i10].f3459a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f10) {
            ...
            while (true) {
                float[] fArr = bVar.f3460b;
                if (i10 < fArr.length) {
                    this.f3460b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f3460b[i10] * f10);
                    i10++;
                } else {
                    return;
                }
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f3459a != bVarArr2[i10].f3459a || bVarArr[i10].f3460b.length != bVarArr2[i10].f3460b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f3459a = bVarArr2[i10].f3459a;
            for (int i11 = 0; i11 < bVarArr2[i10].f3460b.length; i11++) {
                bVarArr[i10].f3460b[i11] = bVarArr2[i10].f3460b[i11];
            }
        }
    }
}
