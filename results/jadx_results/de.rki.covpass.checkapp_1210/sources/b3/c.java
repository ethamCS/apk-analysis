...
public class c extends a3.a<c4.g> {
    @Override // a3.d
    ...
    public float f(float f10, float f11) {
        ...
        float f13 = f11 - i11;
        T t10 = this.f180b;
        int i12 = ((c4.g) t10).f6218c;
        int i13 = this.f181c;
        int i14 = i12 + (i11 * i13) + i10;
        short[] sArr = ((c4.g) t10).V3;
        float f14 = 1.0f - f12;
        float f15 = 1.0f - f13;
        int i15 = i14 + 1;
        return (f14 * f15 * sArr[i14]) + (f15 * f12 * sArr[i15]) + (f12 * f13 * sArr[i15 + i13]) + (f14 * f13 * sArr[i14 + i13]);
    }
}
