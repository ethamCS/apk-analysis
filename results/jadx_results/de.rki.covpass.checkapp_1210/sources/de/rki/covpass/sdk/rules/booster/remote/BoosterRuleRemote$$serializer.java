...
@Metadata(bv = {}, d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001a\u0010\u0005\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00040\u0003HÖ\u0001¢\u0006\u0004\b\u0005\u0010\u0006J\u0011\u0010\t\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0007HÖ\u0001J\u0019\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"de/rki/covpass/sdk/rules/booster/remote/BoosterRuleRemote.$serializer", "Lkf/v;", "Lde/rki/covpass/sdk/rules/booster/remote/BoosterRuleRemote;", BuildConfig.FLAVOR, "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "Ltb/e0;", "serialize", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "covpass-sdk_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes.dex */
public final class BoosterRuleRemote$$serializer implements v<BoosterRuleRemote> {
    ...
    static {
        ...
        x0 x0Var = new x0("de.rki.covpass.sdk.rules.booster.remote.BoosterRuleRemote", boosterRuleRemote$$serializer, 14);
    ...
    public KSerializer<?>[] childSerializers() {
        k1 k1Var = k1.f15181a;
        return new KSerializer[]{k1Var, k1Var, k1Var, k1Var, k1Var, k1Var, k1Var, new f(BoosterDescriptionRemote$$serializer.INSTANCE), new ContextualSerializer(k0.b(ZonedDateTime.class), null, new KSerializer[0]), new ContextualSerializer(k0.b(ZonedDateTime.class), null, new KSerializer[0]), new f(k1Var), h.f15995a, k1Var, BuiltinSerializersKt.p(k1Var)};
    }
    ...
    public BoosterRuleRemote deserialize(Decoder decoder) {
        ...
        if (b10.r()) {
            ...
            obj3 = b10.C(descriptor2, 7, new f(BoosterDescriptionRemote$$serializer.INSTANCE), null);
            ...
            while (z10) {
                ...
                switch (q10) {
                    ...
                    case 6:
                        ...
                        i11 = 13;
                    case 7:
                        obj12 = b10.C(descriptor2, 7, new f(BoosterDescriptionRemote$$serializer.INSTANCE), obj12);
                        i12 |= 128;
                        c14 = 7;
                        i11 = 13;
                    case 8:
        ...
        b10.c(descriptor2);
        return new BoosterRuleRemote(i10, str8, str7, str6, str5, str4, str3, str2, obj3, obj2, obj5, obj, obj6, str, obj4, null);
    }
    ...
    public void serialize(Encoder encoder, BoosterRuleRemote boosterRuleRemote) {
        ...
        BoosterRuleRemote.o(boosterRuleRemote, b10, descriptor2);
        b10.c(descriptor2);
    }
