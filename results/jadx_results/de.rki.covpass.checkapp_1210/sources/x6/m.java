...
final class m {
    ...
    /* renamed from: a */
    private final List<int[]> f25421a = new ArrayList();

    /* renamed from: b */
    private final List<String> f25422b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f25421a.add(iArr);
        this.f25422b.add(str);
    }

    private synchronized void b() {
        if (!this.f25421a.isEmpty()) {
            return;
        }
    ...
    public String c(String str) {
        ...
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = this.f25421a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return this.f25422b.get(i11);
            }
        }
        return null;
    }
