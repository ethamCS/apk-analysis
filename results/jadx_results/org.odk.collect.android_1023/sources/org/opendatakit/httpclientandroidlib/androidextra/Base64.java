...
public class Base64 {
    ...
    public static class Decoder extends Coder {
        ...
        @Override // org.opendatakit.httpclientandroidlib.androidextra.Base64.Coder
        ...
        */
        public boolean process(byte[] r12, int r13, int r14, boolean r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.opendatakit.httpclientandroidlib.androidextra.Base64.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
        ...
        */
        public boolean process(byte[] r15, int r16, int r17, boolean r18) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: org.opendatakit.httpclientandroidlib.androidextra.Base64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
