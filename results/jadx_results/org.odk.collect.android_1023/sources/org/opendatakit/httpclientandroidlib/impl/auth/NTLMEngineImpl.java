...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class Type1Message extends NTLMMessage {
        ...
        @Override // org.opendatakit.httpclientandroidlib.impl.auth.NTLMEngineImpl.NTLMMessage
        String getResponse() {
            int finalLength = this.hostBytes.length + 32 + this.domainBytes.length;
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String domain, String host, String user, String password, byte[] nonce, int type2Flags, String target, byte[] targetInformation) throws NTLMEngineException {
            ...
            try {
                if (targetInformation != null && target != null) {
                    ...
                    this.ntResp = NTLMEngineImpl.getNTLM2SessionResponse(password, nonce, clientChallenge2);
        ...
        String getResponse() {
            ...
            addULong(536871429 | (this.type2Flags & NTLMEngineImpl.FLAG_NEGOTIATE_NTLM2) | (this.type2Flags & 16) | (this.type2Flags & 32) | (this.type2Flags & NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH) | (this.type2Flags & NTLMEngineImpl.FLAG_NEGOTIATE_ALWAYS_SIGN));
    ...
    @Override // org.opendatakit.httpclientandroidlib.impl.auth.NTLMEngine
