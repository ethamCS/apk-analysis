...
public class SignatureWidget extends QuestionWidget implements IBinaryWidget {
    ...
    private Button mSignButton = new Button(getContext());
    ...
    public SignatureWidget(Context context, FormEntryPrompt prompt) {
        ...
        this.mSignButton.setEnabled(!prompt.isReadOnly());
        this.mSignButton.setLayoutParams(params);
    ...
    public void launchSignatureActivity() {
        ...
        try {
            ...
            ((Activity) getContext()).startActivityForResult(i, 14);
    ...
    public void setOnLongClickListener(View.OnLongClickListener l) {
        this.mSignButton.setOnLongClickListener(l);
