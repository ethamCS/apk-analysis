...
public class DateTimeFormatter {
    ...
    public int parseInto(ReadWritableInstant readWritableInstant, String str, int i) {
        ...
        Chronology selectChronology = selectChronology(chronology);
        DateTimeParserBucket dateTimeParserBucket = new DateTimeParserBucket(millis + chronology.getZone().getOffset(millis), selectChronology, this.iLocale, this.iPivotYear, this.iDefaultYear);
