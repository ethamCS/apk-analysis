...
public class SimpleCharStream {
    ...
    protected void ExpandBuff(boolean wrapAround) {
        char[] newbuffer = new char[this.bufsize + Logger.MAX_MSG_LENGTH];
        int[] newbufline = new int[this.bufsize + Logger.MAX_MSG_LENGTH];
        int[] newbufcolumn = new int[this.bufsize + Logger.MAX_MSG_LENGTH];
        try {
            if (wrapAround) {
            ...
            this.bufsize += Logger.MAX_MSG_LENGTH;
