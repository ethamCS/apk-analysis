    ...
    public String getMessage() {
        ...
        for (int i = 0; i < this.expectedTokenSequences.length; i++) {
            ...
            for (int j = 0; j < this.expectedTokenSequences[i].length; j++) {
                expected.append(this.tokenImage[this.expectedTokenSequences[i][j]]).append(XFormAnswerDataSerializer.DELIMITER);
            }
        ...
        while (true) {
            ...
            if (i2 != 0) {
                retval2 = retval2 + XFormAnswerDataSerializer.DELIMITER;
            }
            if (tok.kind == 0) {
