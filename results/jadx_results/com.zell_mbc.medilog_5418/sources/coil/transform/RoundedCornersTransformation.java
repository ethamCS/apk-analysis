...
public final class RoundedCornersTransformation implements Transformation {
    ...
    public Object transform(BitmapPool bitmapPool, Bitmap bitmap, Size size, Continuation<? super Bitmap> continuation) {
        ...
        if (size instanceof PixelSize) {
            ...
            i2 = MathKt.roundToInt(pixelSize.getWidth() / computeSizeMultiplier);
            i = MathKt.roundToInt(pixelSize.getHeight() / computeSizeMultiplier);
        ...
        matrix.setTranslate((i2 - bitmap.getWidth()) / 2.0f, (i - bitmap.getHeight()) / 2.0f);
