...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m6212delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6213toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6213toDelayMillisLRDsOJo(long j) {
        if (Duration.m6055compareToLRDsOJo(j, Duration.Companion.m6158getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6074getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
