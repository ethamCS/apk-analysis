...
public interface SendChannel<E> {
    ...
    Object mo6224trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo6224trySendJP2dKIU = sendChannel.mo6224trySendJP2dKIU(e);
            if (ChannelResult.m6239isSuccessimpl(mo6224trySendJP2dKIU)) {
                return true;
            }
            Throwable m6233exceptionOrNullimpl = ChannelResult.m6233exceptionOrNullimpl(mo6224trySendJP2dKIU);
