...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo6222receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo6222receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo6223tryReceivePtdJZtk() {
        return this._channel.mo6223tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo6224trySendJP2dKIU(E e) {
        return this._channel.mo6224trySendJP2dKIU(e);
    }
