...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        if (mo6224trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m6241unboximpl();
        }
        Unit unit = (Unit) mo6224trySendJP2dKIU;
        return ChannelResult.Companion.m6244successJP2dKIU(Unit.INSTANCE);
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m6239isSuccessimpl(sendChannel.mo6224trySendJP2dKIU(e))) {
            return;
        }
