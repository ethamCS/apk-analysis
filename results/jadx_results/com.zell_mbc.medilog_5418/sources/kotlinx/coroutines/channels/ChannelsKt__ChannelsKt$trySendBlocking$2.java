...
public final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            obj2 = Result.m4749constructorimpl(Unit.INSTANCE);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj2 = Result.m4749constructorimpl(ResultKt.createFailure(th));
        }
        return ChannelResult.m6229boximpl(Result.m4756isSuccessimpl(obj2) ? ChannelResult.Companion.m6244successJP2dKIU(Unit.INSTANCE) : ChannelResult.Companion.m6242closedJP2dKIU(Result.m4752exceptionOrNullimpl(obj2)));
    }
}
