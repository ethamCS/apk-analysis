...
public abstract class ComparisonCriteria {
    ...
    private void arrayEquals(String str, Object obj, Object obj2, boolean z) throws ArrayComparisonFailure {
        ...
        if (length != length2) {
            str3 = str3 + "array lengths differed, expected.length=" + length2 + " actual.length=" + length + "; ";
        }
        ...
        for (int i = 0; i < min; i++) {
            ...
            if (isArray(obj3) && isArray(obj4)) {
                try {
                    ...
                    throw new ArrayComparisonFailure(str3, e2, i);
                }
            } else {
                try {
                    assertElementsEqual(obj3, obj4);
                } catch (AssertionError e3) {
                    throw new ArrayComparisonFailure(str3, e3, i);
                }
            }
        }
        if (length == length2) {
        ...
        try {
            ...
            throw new ArrayComparisonFailure(str3, e4, min);
        }
    }
