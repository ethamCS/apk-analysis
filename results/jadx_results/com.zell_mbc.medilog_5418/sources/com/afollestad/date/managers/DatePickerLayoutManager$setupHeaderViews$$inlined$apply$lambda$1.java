...
public final class DatePickerLayoutManager$setupHeaderViews$$inlined$apply$lambda$1 extends Lambda implements Function1<TextView, Unit> {
    final /* synthetic */ DatePickerLayoutManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DatePickerLayoutManager$setupHeaderViews$$inlined$apply$lambda$1(DatePickerLayoutManager datePickerLayoutManager) {
        super(1);
