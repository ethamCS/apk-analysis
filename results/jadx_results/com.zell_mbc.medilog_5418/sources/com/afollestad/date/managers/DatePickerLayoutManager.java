...
public final class DatePickerLayoutManager {
    ...
    public DatePickerLayoutManager(Context context, TypedArray typedArray, ViewGroup root, VibratorController vibrator) {
    ...
    public final Size onMeasure(int i, int i2) {
        ...
        if (size2 <= 0 || this.orientation == Orientation.PORTRAIT) {
            i3 = View.MeasureSpec.makeMeasureSpec(0, 0);
        } else {
            i3 = View.MeasureSpec.makeMeasureSpec(size2 - this.selectedYearView.getMeasuredHeight(), BasicMeasure.EXACTLY);
        }
        textView.measure(makeMeasureSpec, i3);
        int i8 = this.orientation == Orientation.PORTRAIT ? size : size - i7;
        ...
        if (size2 > 0) {
            i6 = View.MeasureSpec.makeMeasureSpec(size2 - i9, Integer.MIN_VALUE);
        } else {
        ...
        size3.setWidth(size);
        size3.setHeight(i9 + this.daysRecyclerView.getMeasuredHeight() + this.chevronsTopMargin + this.currentMonthTopMargin);
        return size3;
    }

    public final void onLayout(int i, int i2, int i3) {
        int i4;
        ViewsKt.placeAt$default(this.selectedYearView, i2, 0, 0, 0, 14, null);
        ViewsKt.placeAt$default(this.selectedDateView, this.selectedYearView.getBottom(), 0, 0, 0, 14, null);
        if (this.orientation != Orientation.PORTRAIT) {
        ...
        ViewsKt.placeAt$default(textView2, i4, measuredWidth, 0, 0, 12, null);
        ViewsKt.placeAt$default(this.listsDividerView, this.visibleMonthView.getBottom(), i, 0, 0, 12, null);
        ViewsKt.placeAt$default(this.daysRecyclerView, this.listsDividerView.getBottom(), i + this.calendarHorizontalPadding, 0, 0, 12, null);
        ...
        ViewsKt.placeAt$default(this.goPreviousMonthView, bottom, this.daysRecyclerView.getLeft() + this.calendarHorizontalPadding, 0, 0, 12, null);
        ViewsKt.placeAt$default(this.goNextMonthView, bottom, (this.daysRecyclerView.getRight() - this.goNextMonthView.getMeasuredWidth()) - this.calendarHorizontalPadding, 0, 0, 12, null);
    ...
    public final void setHeadersContent(Calendar currentMonth, Calendar selectedDate) {
        Intrinsics.checkParameterIsNotNull(currentMonth, "currentMonth");
        Intrinsics.checkParameterIsNotNull(selectedDate, "selectedDate");
        this.visibleMonthView.setText(this.dateFormatter.monthAndYear(currentMonth));
        this.selectedYearView.setText(this.dateFormatter.year(selectedDate));
        this.selectedDateView.setText(this.dateFormatter.date(selectedDate));
    }
    ...
    public final void onNavigate(Function0<Unit> onGoToPrevious, Function0<Unit> onGoToNext) {
        ...
        DebouncerKt.onClickDebounced(this.goPreviousMonthView, new DatePickerLayoutManager$onNavigate$1(onGoToPrevious));
        DebouncerKt.onClickDebounced(this.goNextMonthView, new DatePickerLayoutManager$onNavigate$2(onGoToNext));
    }
    ...
    private final void setupListViews() {
        ...
        ViewsKt.updatePadding$default(recyclerView, i, 0, i, 0, 10, null);
    ...
    public static final class Companion {
        ...
        public final DatePickerLayoutManager inflateInto(Context context, TypedArray typedArray, ViewGroup container) {
            Intrinsics.checkParameterIsNotNull(context, "context");
            Intrinsics.checkParameterIsNotNull(typedArray, "typedArray");
