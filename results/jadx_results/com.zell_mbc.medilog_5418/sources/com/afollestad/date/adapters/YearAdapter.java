...
public final class YearAdapter extends RecyclerView.Adapter<YearViewHolder> {
    ...
    public YearAdapter(Typeface normalFont, Typeface mediumFont, int i, Function1<? super Integer, Unit> onSelection) {
        ...
        int year = CalendarsKt.getYear(calendar);
    ...
    public YearViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        YearViewHolder yearViewHolder = new YearViewHolder(ViewsKt.inflate(parent, R.layout.year_list_row), this);
