...
public final class MonthAdapter extends RecyclerView.Adapter<MonthViewHolder> {
    ...
    public MonthAdapter(int i, Typeface normalFont, Typeface mediumFont, DateFormatter dateFormatter, Function1<? super Integer, Unit> onSelection) {
