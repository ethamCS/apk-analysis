...
public final class Util {
    ...
    public final ColorStateList createTextSelector(Context context, int i, boolean z) {
        ...
        int resolveColor$default = ContextsKt.resolveColor$default(context, 16842807, null, 2, null);
        int resolveColor$default2 = ContextsKt.resolveColor$default(context, 16842806, null, 2, null);
        int[] iArr2 = new int[3];
        iArr2[0] = resolveColor$default;
        iArr2[1] = resolveColor$default2;
        if (z) {
            i = ColorsKt.isColorDark$default(i, 0.0d, 1, null) ? -1 : ViewCompat.MEASURED_STATE_MASK;
        }
        iArr2[2] = i;
