...
public final class AesCtrHmacStreaming extends NonceBasedStreamingAead {
    ...
    public class AesCtrHmacStreamEncrypter implements StreamSegmentEncrypter {
        ...
        public AesCtrHmacStreamEncrypter(byte[] aad) throws GeneralSecurityException {
            AesCtrHmacStreaming.this = this$0;
            this.encryptedSegments = 0L;
            this.mac = this$0.macInstance();
            this.encryptedSegments = 0L;
            byte[] randomSalt = this$0.randomSalt();
            byte[] randomNonce = this$0.randomNonce();
            this.noncePrefix = randomNonce;
            ByteBuffer allocate = ByteBuffer.allocate(this$0.getHeaderLength());
            this.header = allocate;
            allocate.put((byte) this$0.getHeaderLength());
            this.header.put(randomSalt);
            this.header.put(randomNonce);
            this.header.flip();
            byte[] deriveKeyMaterial = this$0.deriveKeyMaterial(randomSalt, aad);
            this.keySpec = this$0.deriveKeySpec(deriveKeyMaterial);
            this.hmacKeySpec = this$0.deriveHmacKeySpec(deriveKeyMaterial);
        }
