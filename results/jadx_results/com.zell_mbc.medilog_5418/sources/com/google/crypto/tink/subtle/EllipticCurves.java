...
public final class EllipticCurves {
    ...
    public static byte[] pointEncode(EllipticCurve curve, PointFormatType format, ECPoint point) throws GeneralSecurityException {
        ...
        if (i == 2) {
            ...
            byte[] byteArray4 = point.getAffineY().toByteArray();
            ...
            System.arraycopy(byteArray4, 0, bArr2, i4 - byteArray4.length, byteArray4.length);
            System.arraycopy(byteArray3, 0, bArr2, fieldSizeInBytes - byteArray3.length, byteArray3.length);
            return bArr2;
        } else if (i == 3) {
            int i5 = fieldSizeInBytes + 1;
            byte[] bArr3 = new byte[i5];
            byte[] byteArray5 = point.getAffineX().toByteArray();
