...
public final class DispatchQueue {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    DispatchQueue.m4401dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, runnable);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m4401dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable runnable) {
