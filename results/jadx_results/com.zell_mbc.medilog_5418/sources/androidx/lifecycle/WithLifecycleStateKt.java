            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        obj = Result.m4749constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m4749constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
