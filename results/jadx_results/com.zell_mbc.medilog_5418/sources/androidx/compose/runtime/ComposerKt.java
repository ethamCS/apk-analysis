...
public final class ComposerKt {
    ...
    public static final PersistentMap<CompositionLocal<Object>, State<Object>> compositionLocalMapOf(ProvidedValue<?>[] providedValueArr, PersistentMap<CompositionLocal<Object>, ? extends State<? extends Object>> persistentMap, Composer composer, int i) {
        ...
        for (ProvidedValue<?> providedValue : providedValueArr) {
            ...
            if (providedValue.getCanOverride() || !contains(persistentMap, providedValue.getCompositionLocal())) {
                ...
                builder2.put(compositionLocal, providedValue.getCompositionLocal().provided$runtime_release(providedValue.getValue(), composer, 72));
            }
    ...
    public static final List<Object> collectNodesFrom(SlotTable slotTable, Anchor anchor) {
        ...
        try {
            m1325collectNodesFrom$lambda10$collectFromGroup(openReader, arrayList, slotTable.anchorIndex(anchor));
    ...
    private static final void m1325collectNodesFrom$lambda10$collectFromGroup(SlotReader slotReader, List<Object> list, int i) {
        ...
        while (i2 < groupSize) {
            m1325collectNodesFrom$lambda10$collectFromGroup(slotReader, list, i2);
