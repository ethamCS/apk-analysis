...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m1326boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl */
    public static <T> Composer m1327constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl */
    public static boolean m1328equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).m1333unboximpl());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m1329equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m1330hashCodeimpl(Composer composer) {
    ...
    public boolean equals(Object obj) {
        return m1328equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m1330hashCodeimpl(this.composer);
    }
    ...
    public final /* synthetic */ Composer m1333unboximpl() {
    ...
    public static final void m1332updateimpl(Composer composer, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        composer.startReplaceableGroup(509942095);
        block.invoke(Updater.m1335boximpl(Updater.m1336constructorimpl(composer)));
