...
public final class TrieNode<E> {
    ...
    private final TrieNode<E> mutableCollisionAddAll(TrieNode<E> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        while (i < objArr2.length) {
            boolean z = true;
            CommonFunctionsKt.m1351assert(i2 <= i);
            if (!collisionContainsElement((E) objArr2[i])) {
                ...
                CommonFunctionsKt.m1351assert(z);
            }
            i++;
        }
    ...
    public final TrieNode<E> mutableAddAll(TrieNode<E> otherNode, int i, DeltaCounter intersectionSizeRef, PersistentHashSetBuilder<?> mutator) {
        ...
        if (this == otherNode) {
            ...
            TrieNode<E> trieNode = (i4 != i3 || !Intrinsics.areEqual(this.ownedBy, mutator.getOwnership$runtime_release())) ? new TrieNode<>(i4, new Object[Integer.bitCount(i4)], mutator.getOwnership$runtime_release()) : this;
            int i5 = i4;
            int i6 = 0;
            while (i5 != 0) {
                ...
                if (hasNoCellAt(lowestOneBit)) {
                    obj = (TrieNode<E>) otherNode.buffer[indexOfCellAt$runtime_release2];
                    ...
                    if (!z || !z2) {
                        if (z) {
                            ...
                            objArr = objArr2;
                            i2 = lowestOneBit;
                            obj = makeNode(e != null ? e.hashCode() : 0, e, e2 != null ? e2.hashCode() : 0, e2, i + 5, mutator.getOwnership$runtime_release());
                            objArr[i6] = obj;
                            i6++;
                            i5 ^= i2;
                        }
                        ...
                        Intrinsics.checkNotNull(e, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableAddAll$lambda-6>");
                        Intrinsics.checkNotNull(e2, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableAddAll$lambda-6>");
                        obj = ((TrieNode) e).mutableAddAll((TrieNode) e2, i + 5, intersectionSizeRef, mutator);
                    }
                }
                objArr = objArr2;
                i2 = lowestOneBit;
    ...
    public final Object mutableRetainAll(TrieNode<E> otherNode, int i, DeltaCounter intersectionSizeRef, PersistentHashSetBuilder<?> mutator) {
        ...
        if (this == otherNode) {
            ...
            TrieNode<E> trieNode2 = (!Intrinsics.areEqual(this.ownedBy, mutator.getOwnership$runtime_release()) || i2 != this.bitmap) ? new TrieNode<>(i2, new Object[Integer.bitCount(i2)], mutator.getOwnership$runtime_release()) : this;
            int i3 = i2;
            int i4 = 0;
            int i5 = 0;
            while (i3 != 0) {
            ...
            if (bitCount == 1 && i != 0) {
                ...
                while (i6 < objArr2.length) {
                    CommonFunctionsKt.m1351assert(i7 <= i6);
                    if (objArr2[i6] != Companion.getEMPTY$runtime_release()) {
                        objArr[0 + i7] = objArr2[i6];
                        i7++;
                        CommonFunctionsKt.m1351assert(0 + i7 <= bitCount);
                    }
                    i6++;
                }
        ...
        if (this == otherNode) {
            ...
            if (i4 == this.bitmap) {
                ...
                while (i5 < objArr4.length) {
                    CommonFunctionsKt.m1351assert(i6 <= i5);
                    if (objArr4[i5] != Companion.getEMPTY$runtime_release()) {
                        objArr3[0 + i6] = objArr4[i5];
                        i6++;
                        CommonFunctionsKt.m1351assert(0 + i6 <= bitCount);
                    }
                    i5++;
                }
    ...
    public final TrieNode<E> add(int i, E e, int i2) {
        ...
        return nodeAtIndex == trieNode ? this : updateNodeAtIndex(indexOfCellAt$runtime_release, trieNode);
    }
    ...
    public final TrieNode<E> mutableAdd(int i, E e, int i2, PersistentHashSetBuilder<?> mutator) {
        ...
        if (objArr[indexOfCellAt$runtime_release] instanceof TrieNode) {
            TrieNode<E> nodeAtIndex = nodeAtIndex(indexOfCellAt$runtime_release);
            if (i2 == 30) {
                trieNode = nodeAtIndex.mutableCollisionAdd(e, mutator);
            } else {
                trieNode = nodeAtIndex.mutableAdd(i, e, i2 + 5, mutator);
            }
            return nodeAtIndex == trieNode ? this : mutableUpdateNodeAtIndex(indexOfCellAt$runtime_release, trieNode, mutator.getOwnership$runtime_release());
        } else if (Intrinsics.areEqual(e, objArr[indexOfCellAt$runtime_release])) {
            return this;
        } else {
            mutator.setSize(mutator.size() + 1);
    ...
    public final TrieNode<E> mutableRemove(int i, E e, int i2, PersistentHashSetBuilder<?> mutator) {
        ...
        if (objArr[indexOfCellAt$runtime_release] instanceof TrieNode) {
            TrieNode<E> nodeAtIndex = nodeAtIndex(indexOfCellAt$runtime_release);
            if (i2 == 30) {
                trieNode = nodeAtIndex.mutableCollisionRemove(e, mutator);
            } else {
                trieNode = nodeAtIndex.mutableRemove(i, e, i2 + 5, mutator);
            }
            return (this.ownedBy == mutator.getOwnership$runtime_release() || nodeAtIndex != trieNode) ? mutableUpdateNodeAtIndex(indexOfCellAt$runtime_release, trieNode, mutator.getOwnership$runtime_release()) : this;
        } else if (!Intrinsics.areEqual(e, objArr[indexOfCellAt$runtime_release])) {
            return this;
        } else {
            mutator.setSize(mutator.size() - 1);
