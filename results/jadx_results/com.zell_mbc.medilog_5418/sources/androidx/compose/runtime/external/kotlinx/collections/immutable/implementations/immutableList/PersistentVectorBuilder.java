...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements PersistentList.Builder<E> {
    ...
    public boolean addAll(int i, Collection<? extends E> elements) {
        ...
        if (size == 0) {
            ...
            int i3 = i & 31;
            Object[] objArr2 = this.tail;
            Object[] copyInto = ArraysKt.copyInto(objArr2, makeMutable(objArr2), (((i + elements.size()) - 1) & 31) + 1, i3, tailSize());
            copyToBuffer(copyInto, i3, elements.iterator());
            this.tail = copyInto;
            this.size = size() + elements.size();
            return true;
        }
        ...
        if (i >= rootSize()) {
            ...
            splitToBuffers(elements, i, this.tail, tailSize, objArr3, size, objArr);
        } else if (tailSize2 > tailSize) {
            int i4 = tailSize2 - tailSize;
            objArr = makeMutableShiftingRight(this.tail, i4);
            insertIntoRoot(elements, i, i4, objArr3, size, objArr);
        } else {
            int i5 = tailSize - tailSize2;
            objArr = ArraysKt.copyInto(this.tail, mutableBuffer(), 0, i5, tailSize);
            int i6 = 32 - i5;
            Object[] makeMutableShiftingRight = makeMutableShiftingRight(this.tail, i6);
            int i7 = size - 1;
            objArr3[i7] = makeMutableShiftingRight;
            insertIntoRoot(elements, i, i6, objArr3, i7, makeMutableShiftingRight);
        }
    ...
    private final void splitToBuffers(Collection<? extends E> collection, int i, Object[] objArr, int i2, Object[][] objArr2, int i3, Object[] objArr3) {
        ...
        if (i5 < 32) {
            ...
            ArraysKt.copyInto(makeMutable, objArr4, size + 1, i4, i7);
            objArr3 = objArr4;
        }
    ...
    private final Object removeFromTailAt(Object[] objArr, int i, int i2, int i3) {
        int size = size() - i;
        CommonFunctionsKt.m1351assert(i3 < size);
        if (size == 1) {
    ...
    private final Object[] pullLastBuffer(Object[] objArr, int i, int i2, ObjectRef objectRef) {
        ...
        if (i == 5) {
            ...
            objArr2 = pullLastBuffer((Object[]) obj, i - 5, i2, objectRef);
        }
    ...
    private final boolean removeAll(Function1<? super E, Boolean> function1) {
        ...
        if (i == 32) {
            CommonFunctionsKt.m1351assert(!leafBufferIterator.hasNext());
        ...
        ArraysKt.fill(objArr2, (Object) null, recyclableRemoveAll, 32);
        ...
        this.root = retainFirst(objArr, size);
        this.tail = objArr2;
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> function1, int i, ObjectRef objectRef) {
        ...
        if (removeAll == i) {
            CommonFunctionsKt.m1351assert(objectRef.getValue() == this.tail);
            return i;
        }
        Object value = objectRef.getValue();
        Intrinsics.checkNotNull(value, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    ...
    private final int recyclableRemoveAll(Function1<? super E, Boolean> function1, Object[] objArr, int i, int i2, ObjectRef objectRef, List<Object[]> list, List<Object[]> list2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (!function1.invoke(obj).booleanValue()) {
                if (i2 == 32) {
                    if (!list.isEmpty()) {
                        objArr2 = list.remove(list.size() - 1);
                    } else {
