...
public final class ExtensionsKt {
    ...
    public static final <T> PersistentList<T> toPersistentList(Iterable<? extends T> iterable) {
        ...
        if (persistentList2 == null) {
            ...
            return persistentList == null ? plus(persistentListOf(), (Iterable) iterable) : persistentList;
        }
    ...
    public static final <T> PersistentSet<T> toPersistentSet(Iterable<? extends T> iterable) {
        ...
        return persistentSet == null ? plus(PersistentOrderedSet.Companion.emptyOf$runtime_release(), (Iterable) iterable) : persistentSet;
    }
    ...
    public static final <K, V> PersistentMap<K, V> toPersistentMap(Map<K, ? extends V> map) {
        ...
        return persistentMap == null ? PersistentOrderedMap.Companion.emptyOf$runtime_release().putAll((Map) map) : persistentMap;
    }
