...
public final class AndroidConfig implements ScrollConfig {
    ...
    public long mo252calculateMouseWheelScroll8xgXZGE(Density calculateMouseWheelScroll, PointerEvent event, long j) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset m1448boximpl = Offset.m1448boximpl(Offset.Companion.m1475getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            m1448boximpl = Offset.m1448boximpl(Offset.m1464plusMKHz9U(m1448boximpl.m1469unboximpl(), changes.get(i).m3079getScrollDeltaF1C5BW0()));
        }
        return Offset.m1466timestuRUvjQ(m1448boximpl.m1469unboximpl(), -calculateMouseWheelScroll.mo331toPx0680j_4(Dp.m4106constructorimpl(64)));
    }
}
