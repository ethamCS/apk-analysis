...
public final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float f) {
        ...
        value.m342dispatchScroll3eAAhYA(this.latestScrollScope, value.m352toOffsettuRUvjQ(f), NestedScrollSource.Companion.m2975getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float f) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m346performRawScrollMKHz9U(value.m352toOffsettuRUvjQ(f));
    }
}
