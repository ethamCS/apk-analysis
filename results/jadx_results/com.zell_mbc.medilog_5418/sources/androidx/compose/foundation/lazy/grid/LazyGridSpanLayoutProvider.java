...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(GridItemSpan.m576boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x00b0 A[LOOP:0: B:35:0x00b0->B:83:0x00b0, LOOP_START, PHI: r2 r4 r5 
      PHI: (r2v6 int) = (r2v5 int), (r2v10 int) binds: [B:34:0x00ae, B:83:0x00b0] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r4v5 int) = (r4v4 int), (r4v6 int) binds: [B:34:0x00ae, B:83:0x00b0] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r5v5 int) = (r5v4 int), (r5v13 int) binds: [B:34:0x00ae, B:83:0x00b0] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* renamed from: getLineIndexOfItem--_Ze7BM */
    public final int m626getLineIndexOfItem_Ze7BM(int i) {
        if (getTotalSize() <= 0) {
            return LineIndex.m636constructorimpl(0);
        }
        if (!(i < getTotalSize())) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        if (!this.itemProvider.getHasCustomSpans()) {
            return LineIndex.m636constructorimpl(i / this.slotsPerLine);
        }
        ...
        return LineIndex.m636constructorimpl(bucketSize);
    }
    ...
    private final int spanOf(int i, int i2) {
        ...
        return RangesKt.coerceIn(GridItemSpan.m580getCurrentLineSpanimpl(lazyGridItemProvider.mo611getSpan_orMbw(lazyGridItemSpanScopeImpl, i)), 1, this.slotsPerLine);
    }
