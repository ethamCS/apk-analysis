...
public final class PlaceableInfo {
    ...
    private PlaceableInfo(long j, int i) {
        ...
        this.mainAxisSize = i;
        this.animatedOffset = new Animatable<>(IntOffset.m4215boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, 4, null);
        this.targetOffset = j;
    ...
    /* renamed from: getTargetOffset-nOcc-ac */
    public final long m647getTargetOffsetnOccac() {
        return this.targetOffset;
    }

    /* renamed from: setTargetOffset--gyyYBs */
    public final void m648setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }
