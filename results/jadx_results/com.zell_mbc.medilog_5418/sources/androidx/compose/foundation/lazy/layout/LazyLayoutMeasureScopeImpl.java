...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo324roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo324roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo325roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo325roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo330toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo330toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo331toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo331toPx0680j_4(f);
    }
    ...
    public List<Placeable> mo650measure0kLqBqw(int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(subcompose.get(i2).mo3206measureBRTryo0(j));
        }
    ...
    public float mo326toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo326toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo328toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo328toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo327toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo327toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo334toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo334toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo335toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo335toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo333toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo333toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSize-XkaWNTQ */
    public long mo332toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo332toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo329toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo329toDpSizekrfVVM(j);
    }
}
