...
/* renamed from: androidx.compose.foundation.layout.OffsetKt$absoluteOffset-VpY3zN4$$inlined$debugInspectorInfo$1 */
...
public final class OffsetKt$absoluteOffsetVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("x", Dp.m4104boximpl(this.$x$inlined));
        inspectorInfo.getProperties().set("y", Dp.m4104boximpl(this.$y$inlined));
    }
}
