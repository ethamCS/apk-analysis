...
/* renamed from: androidx.compose.foundation.layout.PaddingKt$padding-qDBjuR0$$inlined$debugInspectorInfo$1 */
...
public final class PaddingKt$paddingqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("start", Dp.m4104boximpl(this.$start$inlined));
        inspectorInfo.getProperties().set("top", Dp.m4104boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set("end", Dp.m4104boximpl(this.$end$inlined));
