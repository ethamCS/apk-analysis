...
final class LimitInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m520getAllowLeftInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m521getAllowLeftInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m513hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m513hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m530getTopJoeWqyM())) {
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        ...
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (layoutDirection == LayoutDirection.Ltr) {
            i = WindowInsetsSides.Companion.m522getAllowRightInLtrJoeWqyM$foundation_layout_release();
        } else {
            i = WindowInsetsSides.Companion.m523getAllowRightInRtlJoeWqyM$foundation_layout_release();
        }
        if (WindowInsetsSides.m513hasAnybkgdKaI$foundation_layout_release(this.sides, i)) {
    ...
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m513hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.Companion.m524getBottomJoeWqyM())) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.insets, limitInsets.insets) && WindowInsetsSides.m512equalsimpl0(this.sides, limitInsets.sides);
    }

    public int hashCode() {
        return (this.insets.hashCode() * 31) + WindowInsetsSides.m514hashCodeimpl(this.sides);
    }

    public String toString() {
        return '(' + this.insets + " only " + ((Object) WindowInsetsSides.m516toStringimpl(this.sides)) + ')';
    }
}
