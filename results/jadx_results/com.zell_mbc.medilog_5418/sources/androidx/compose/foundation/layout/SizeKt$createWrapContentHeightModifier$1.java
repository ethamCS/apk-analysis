...
final class SizeKt$createWrapContentHeightModifier$1 extends Lambda implements Function2<IntSize, LayoutDirection, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
        return IntOffset.m4215boximpl(m496invoke5SAbXVA(intSize.m4270unboximpl(), layoutDirection));
    }

    /* renamed from: invoke-5SAbXVA */
    public final long m496invoke5SAbXVA(long j, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "<anonymous parameter 1>");
        return IntOffsetKt.IntOffset(0, this.$align.align(0, IntSize.m4265getHeightimpl(j)));
    }
}
