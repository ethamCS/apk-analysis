...
public final class OrientationIndependentConstraints {
    ...
    private OrientationIndependentConstraints(long j, LayoutOrientation layoutOrientation) {
        this(layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4052getMinWidthimpl(j) : Constraints.m4051getMinHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4050getMaxWidthimpl(j) : Constraints.m4049getMaxHeightimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4051getMinHeightimpl(j) : Constraints.m4052getMinWidthimpl(j), layoutOrientation == LayoutOrientation.Horizontal ? Constraints.m4049getMaxHeightimpl(j) : Constraints.m4050getMaxWidthimpl(j));
    }
    ...
    public final long m439toBoxConstraintsOenEA2s(LayoutOrientation orientation) {
