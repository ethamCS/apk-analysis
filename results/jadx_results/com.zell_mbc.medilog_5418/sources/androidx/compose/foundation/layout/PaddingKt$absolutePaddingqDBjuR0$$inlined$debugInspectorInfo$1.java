...
/* renamed from: androidx.compose.foundation.layout.PaddingKt$absolutePadding-qDBjuR0$$inlined$debugInspectorInfo$1 */
...
public final class PaddingKt$absolutePaddingqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("left", Dp.m4104boximpl(this.$left$inlined));
        inspectorInfo.getProperties().set("top", Dp.m4104boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set("right", Dp.m4104boximpl(this.$right$inlined));
        inspectorInfo.getProperties().set("bottom", Dp.m4104boximpl(this.$bottom$inlined));
    }
}
