...
public interface PaddingValues {
    ...
    float mo426calculateBottomPaddingD9Ej5fM();

    /* renamed from: calculateLeftPadding-u2uoSUM */
    float mo427calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo428calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM */
    float mo429calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m4111equalsimpl0(this.left, absolute.left) && Dp.m4111equalsimpl0(this.top, absolute.top) && Dp.m4111equalsimpl0(this.right, absolute.right) && Dp.m4111equalsimpl0(this.bottom, absolute.bottom);
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m4117toStringimpl(this.left)) + ", top=" + ((Object) Dp.m4117toStringimpl(this.top)) + ", right=" + ((Object) Dp.m4117toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m4117toStringimpl(this.bottom)) + ')';
        }
