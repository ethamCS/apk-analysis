...
public final class FixedDpInsets implements WindowInsets {
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m4117toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m4117toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m4117toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m4117toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m4111equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m4111equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m4111equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m4111equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m4112hashCodeimpl(this.leftDp) * 31) + Dp.m4112hashCodeimpl(this.topDp)) * 31) + Dp.m4112hashCodeimpl(this.rightDp)) * 31) + Dp.m4112hashCodeimpl(this.bottomDp);
    }
}
