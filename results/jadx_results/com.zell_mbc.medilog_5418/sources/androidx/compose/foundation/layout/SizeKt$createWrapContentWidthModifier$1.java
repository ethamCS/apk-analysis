...
final class SizeKt$createWrapContentWidthModifier$1 extends Lambda implements Function2<IntSize, LayoutDirection, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize, LayoutDirection layoutDirection) {
        return IntOffset.m4215boximpl(m498invoke5SAbXVA(intSize.m4270unboximpl(), layoutDirection));
    }

    /* renamed from: invoke-5SAbXVA */
    public final long m498invoke5SAbXVA(long j, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return IntOffsetKt.IntOffset(this.$align.align(0, IntSize.m4266getWidthimpl(j), layoutDirection), 0);
    }
}
