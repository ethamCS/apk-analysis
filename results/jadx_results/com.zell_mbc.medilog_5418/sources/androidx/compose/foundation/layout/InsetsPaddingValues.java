...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo427calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo328toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo429calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo328toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo428calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo328toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo426calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo328toDpu2uoSUM(this.insets.getBottom(density));
    }
