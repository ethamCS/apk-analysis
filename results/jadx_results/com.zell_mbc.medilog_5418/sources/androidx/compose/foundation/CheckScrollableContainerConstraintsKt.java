...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m193checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        boolean z = true;
        if (orientation == Orientation.Vertical) {
            if (Constraints.m4049getMaxHeightimpl(j) == Integer.MAX_VALUE) {
                z = false;
            }
            if (!z) {
        ...
        if (Constraints.m4050getMaxWidthimpl(j) == Integer.MAX_VALUE) {
            z = false;
        }
        if (!z) {
