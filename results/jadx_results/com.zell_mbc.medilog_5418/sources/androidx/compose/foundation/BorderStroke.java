...
public final class BorderStroke {
    ...
    public final float m191getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m4111equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }

    public int hashCode() {
        return (Dp.m4112hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m4117toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default */
    public static /* synthetic */ BorderStroke m189copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m190copyD5KLDUw(f, brush);
    }

    /* renamed from: copy-D5KLDUw */
    public final BorderStroke m190copyD5KLDUw(float f, Brush brush) {
