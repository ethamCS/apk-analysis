...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m708CursorHandleULxng0E(long j, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m816HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(startRestartGroup, -1458480226, true, new AndroidCursorHandle_androidKt$CursorHandle$1(function2, modifier, i2)), startRestartGroup, (i2 & 14) | 432);
            if (ComposerKt.isTraceInProgress()) {
    ...
    static {
        float m4106constructorimpl = Dp.m4106constructorimpl(25);
        CursorHandleHeight = m4106constructorimpl;
        CursorHandleWidth = Dp.m4106constructorimpl(Dp.m4106constructorimpl(m4106constructorimpl * 2.0f) / 2.4142137f);
    }
}
