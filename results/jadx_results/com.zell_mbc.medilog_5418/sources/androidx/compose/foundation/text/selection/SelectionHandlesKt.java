...
public final class SelectionHandlesKt {
    ...
    /* renamed from: getAdjustedCoordinates-k-4lQ0M */
    public static final long m844getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m1459getXimpl(j), Offset.m1460getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m4106constructorimpl(f);
        HandleHeight = Dp.m4106constructorimpl(f);
    }
}
