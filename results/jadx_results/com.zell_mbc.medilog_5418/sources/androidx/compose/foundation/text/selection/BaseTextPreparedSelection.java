...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m818getOriginalSelectiond9O1mEE() {
    ...
    public final long m819getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8 */
    public final void m820setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m3664getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m3664getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        TextLayoutResult textLayoutResult = this.layoutResult;
        return (textLayoutResult != null ? textLayoutResult.getParagraphDirection(TextRange.m3664getEndimpl(this.selection)) : null) != ResolvedTextDirection.Rtl;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        ...
        long m3646getWordBoundaryjx7JFs = textLayoutResult.m3646getWordBoundaryjx7JFs(charOffset(i));
        if (TextRange.m3664getEndimpl(m3646getWordBoundaryjx7JFs) <= i) {
            return getNextWordOffsetForLayout(textLayoutResult, i + 1);
        }
        return this.offsetMapping.transformedToOriginal(TextRange.m3664getEndimpl(m3646getWordBoundaryjx7JFs));
    }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        long m3646getWordBoundaryjx7JFs = textLayoutResult.m3646getWordBoundaryjx7JFs(charOffset(i));
        if (TextRange.m3669getStartimpl(m3646getWordBoundaryjx7JFs) >= i) {
            return getPrevWordOffset(textLayoutResult, i - 1);
        }
        return this.offsetMapping.transformedToOriginal(TextRange.m3669getStartimpl(m3646getWordBoundaryjx7JFs));
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m3644getOffsetForPositionk4lQ0M(OffsetKt.Offset(f.floatValue(), lineBottom)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m3664getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m3667getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m3666getMaximpl(this.selection));
    }
    ...
    private final int getParagraphStart() {
        return StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m3667getMinimpl(this.selection));
    }

    private final int getParagraphEnd() {
        return StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m3666getMaximpl(this.selection));
    }
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            setCursor(TextRange.m3664getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> or) {
        ...
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m3663getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m3667getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m3666getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m3669getStartimpl(this.originalSelection), TextRange.m3664getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
