...
public final class SelectionHandleInfo {
    ...
    /* renamed from: copy-Uv8p0NA$default */
    public static /* synthetic */ SelectionHandleInfo m840copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m842copyUv8p0NA(handle, j);
    }
    ...
    /* renamed from: component2-F1C5BW0 */
    public final long m841component2F1C5BW0() {
        return this.position;
    }

    /* renamed from: copy-Uv8p0NA */
    public final SelectionHandleInfo m842copyUv8p0NA(Handle handle, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m1456equalsimpl0(this.position, selectionHandleInfo.position);
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m1461hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m1467toStringimpl(this.position)) + ')';
    }
    ...
    public final long m843getPositionF1C5BW0() {
        return this.position;
    }
}
