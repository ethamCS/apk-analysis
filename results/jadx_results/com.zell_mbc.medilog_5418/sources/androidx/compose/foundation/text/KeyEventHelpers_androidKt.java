...
public final class KeyEventHelpers_androidKt {
    ...
    /* renamed from: cancelsTextSelection-ZmokQxo */
    public static final boolean m731cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m2931equalsimpl0(KeyEvent_androidKt.m2939getTypeZmokQxo(cancelsTextSelection), KeyEventType.Companion.m2936getKeyUpCS__XNY());
    }
}
