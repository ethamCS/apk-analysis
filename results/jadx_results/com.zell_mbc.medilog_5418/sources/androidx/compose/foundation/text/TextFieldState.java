...
public final class TextFieldState {
    ...
    private Function1<? super TextFieldValue, Unit> onValueChangeOriginal = TextFieldState$onValueChangeOriginal$1.INSTANCE;
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m4104boximpl(Dp.m4106constructorimpl(0)), null, 2, null);
    ...
    public final float m800getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m4120unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4 */
    public final void m801setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField$delegate.setValue(Dp.m4104boximpl(f));
    }
    ...
    public final void m802updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean z, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long j) {
        TextDelegate m727updateTextDelegatex_uQXYA;
        ...
        this.selectionPaint.mo1580setColor8_81llA(j);
        ...
        m727updateTextDelegatex_uQXYA = CoreTextKt.m727updateTextDelegatex_uQXYA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (r20 & 32) != 0 ? true : z, (r20 & 64) != 0 ? TextOverflow.Companion.m4016getClipgIe3tQ8() : 0, (r20 & 128) != 0 ? Integer.MAX_VALUE : 0, CollectionsKt.emptyList());
        if (this.textDelegate != m727updateTextDelegatex_uQXYA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m727updateTextDelegatex_uQXYA;
    }
}
