...
public final class MagnifierStyle {
    ...
    /* renamed from: getSize-MYxV2XQ$foundation_release */
    public final long m248getSizeMYxV2XQ$foundation_release() {
        return this.size;
    }

    /* renamed from: getCornerRadius-D9Ej5fM$foundation_release */
    public final float m246getCornerRadiusD9Ej5fM$foundation_release() {
        return this.cornerRadius;
    }

    /* renamed from: getElevation-D9Ej5fM$foundation_release */
    public final float m247getElevationD9Ej5fM$foundation_release() {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.Companion.m4213getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.Companion.m4126getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.Companion.m4126getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m4201equalsimpl0(this.size, magnifierStyle.size) && Dp.m4111equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m4111equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
    }

    public int hashCode() {
        return (((((((((MagnifierStyle$$ExternalSyntheticBackport0.m(this.useTextDefault) * 31) + DpSize.m4206hashCodeimpl(this.size)) * 31) + Dp.m4112hashCodeimpl(this.cornerRadius)) * 31) + Dp.m4112hashCodeimpl(this.elevation)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.clippingEnabled)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        return "MagnifierStyle(size=" + ((Object) DpSize.m4211toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m4117toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m4117toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
    ...
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(MagnifierStyle style, int i) {
            ...
            return MagnifierKt.isPlatformMagnifierSupported(i) && !style.getFishEyeEnabled$foundation_release() && (style.getUseTextDefault$foundation_release() || Intrinsics.areEqual(style, getDefault()) || i >= 29);
        }
    }
