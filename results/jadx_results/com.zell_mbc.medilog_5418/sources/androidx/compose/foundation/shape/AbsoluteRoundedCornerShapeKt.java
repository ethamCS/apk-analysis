...
public final class AbsoluteRoundedCornerShapeKt {
    ...
    /* renamed from: AbsoluteRoundedCornerShape-0680j_4 */
    public static final AbsoluteRoundedCornerShape m693AbsoluteRoundedCornerShape0680j_4(float f) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m697CornerSize0680j_4(f));
    }
    ...
    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4 */
    public static final AbsoluteRoundedCornerShape m694AbsoluteRoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m697CornerSize0680j_4(f), CornerSizeKt.m697CornerSize0680j_4(f2), CornerSizeKt.m697CornerSize0680j_4(f3), CornerSizeKt.m697CornerSize0680j_4(f4));
    }
    ...
    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4$default */
    public static /* synthetic */ AbsoluteRoundedCornerShape m695AbsoluteRoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m4106constructorimpl(0);
        }
        if ((i & 2) != 0) {
            f2 = Dp.m4106constructorimpl(0);
        }
        if ((i & 4) != 0) {
            f3 = Dp.m4106constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m4106constructorimpl(0);
        }
        return m694AbsoluteRoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
