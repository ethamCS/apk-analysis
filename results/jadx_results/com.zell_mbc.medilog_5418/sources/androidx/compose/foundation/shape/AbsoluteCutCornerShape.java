...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo688createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.moveTo(0.0f, f);
        Path.lineTo(f, 0.0f);
        Path.lineTo(Size.m1528getWidthimpl(j) - f2, 0.0f);
        Path.lineTo(Size.m1528getWidthimpl(j), f2);
        Path.lineTo(Size.m1528getWidthimpl(j), Size.m1525getHeightimpl(j) - f3);
        Path.lineTo(Size.m1528getWidthimpl(j) - f3, Size.m1525getHeightimpl(j));
        Path.lineTo(f4, Size.m1525getHeightimpl(j));
        Path.lineTo(0.0f, Size.m1525getHeightimpl(j) - f4);
        Path.close();
