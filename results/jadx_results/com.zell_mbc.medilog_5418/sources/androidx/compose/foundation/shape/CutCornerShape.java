...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo688createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1528getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m1528getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m1528getWidthimpl(j), Size.m1525getHeightimpl(j) - f6);
        Path.lineTo(Size.m1528getWidthimpl(j) - f6, Size.m1525getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m1525getHeightimpl(j));
        Path.lineTo(0.0f, Size.m1525getHeightimpl(j) - f3);
        Path.close();
