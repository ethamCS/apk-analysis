...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline mo688createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline mo215createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        float mo696toPxTmRCtEA = this.topStart.mo696toPxTmRCtEA(j, density);
        float mo696toPxTmRCtEA2 = this.topEnd.mo696toPxTmRCtEA(j, density);
        float mo696toPxTmRCtEA3 = this.bottomEnd.mo696toPxTmRCtEA(j, density);
        float mo696toPxTmRCtEA4 = this.bottomStart.mo696toPxTmRCtEA(j, density);
        float m1527getMinDimensionimpl = Size.m1527getMinDimensionimpl(j);
        float f = mo696toPxTmRCtEA + mo696toPxTmRCtEA4;
        if (f > m1527getMinDimensionimpl) {
            float f2 = m1527getMinDimensionimpl / f;
            mo696toPxTmRCtEA *= f2;
            mo696toPxTmRCtEA4 *= f2;
        }
        float f3 = mo696toPxTmRCtEA4;
        float f4 = mo696toPxTmRCtEA2 + mo696toPxTmRCtEA3;
        if (f4 > m1527getMinDimensionimpl) {
            float f5 = m1527getMinDimensionimpl / f4;
            mo696toPxTmRCtEA2 *= f5;
            mo696toPxTmRCtEA3 *= f5;
        }
        if (!(mo696toPxTmRCtEA >= 0.0f && mo696toPxTmRCtEA2 >= 0.0f && mo696toPxTmRCtEA3 >= 0.0f && f3 >= 0.0f)) {
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + mo696toPxTmRCtEA + ", topEnd = " + mo696toPxTmRCtEA2 + ", bottomEnd = " + mo696toPxTmRCtEA3 + ", bottomStart = " + f3 + ")!").toString());
        }
        return mo688createOutlineLjSzlW0(j, mo696toPxTmRCtEA, mo696toPxTmRCtEA2, mo696toPxTmRCtEA3, f3, layoutDirection);
    }
