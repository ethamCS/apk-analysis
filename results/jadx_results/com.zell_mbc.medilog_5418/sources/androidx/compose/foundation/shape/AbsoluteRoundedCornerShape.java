...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo688createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m1511RoundRectZAM2FJo(SizeKt.m1549toRectuvyYCjk(j), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f2, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f3, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(f4, 0.0f, 2, null)));
    }
    ...
    /* renamed from: toRadius-Bz7bX_o */
    private final long m692toRadiusBz7bX_o(float f) {
