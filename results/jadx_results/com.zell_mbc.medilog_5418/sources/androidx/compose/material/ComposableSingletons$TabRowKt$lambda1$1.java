...
/* renamed from: androidx.compose.material.ComposableSingletons$TabRowKt$lambda-1$1 */
...
final class ComposableSingletons$TabRowKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        TabRowDefaults.INSTANCE.m1238Divider9IZ8Weo(null, 0.0f, 0L, composer, 3072, 7);
        if (!ComposerKt.isTraceInProgress()) {
            return;
        }
