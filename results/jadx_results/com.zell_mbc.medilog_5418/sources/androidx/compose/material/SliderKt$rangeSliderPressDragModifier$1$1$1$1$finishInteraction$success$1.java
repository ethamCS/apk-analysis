...
final class SliderKt$rangeSliderPressDragModifier$1$1$1$1$finishInteraction$success$1 extends Lambda implements Function1<PointerInputChange, Unit> {
    ...
    public SliderKt$rangeSliderPressDragModifier$1$1$1$1$finishInteraction$success$1(State<? extends Function2<? super Boolean, ? super Float, Unit>> state, Ref.BooleanRef booleanRef, boolean z) {
        super(1);
        this.$onDrag = state;
    ...
    public final void invoke2(PointerInputChange it) {
        ...
        float m1459getXimpl = Offset.m1459getXimpl(PointerEventKt.positionChange(it));
        Function2<Boolean, Float, Unit> value = this.$onDrag.getValue();
        Boolean valueOf = Boolean.valueOf(this.$draggingStart.element);
        if (this.$isRtl) {
            m1459getXimpl = -m1459getXimpl;
        }
        value.invoke(valueOf, Float.valueOf(m1459getXimpl));
    }
}
