...
public final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private final Rect previousWindowVisibleFrame = new Rect();
    private final Rect tmpWindowVisibleFrame = new Rect();
    private final Function2<Offset, IntRect, Boolean> dismissOnOutsideClick = PopupLayout$dismissOnOutsideClick$1.INSTANCE;
    ...
    */
    public PopupLayout(kotlin.jvm.functions.Function0<kotlin.Unit> r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            r12 = 8
            float r12 = (float) r12
            float r12 = androidx.compose.ui.unit.Dp.m4106constructorimpl(r12)
            ...
            float r10 = r11.mo331toPx0680j_4(r12)
            r7.setElevation(r10)
            ...
            kotlin.jvm.functions.Function2 r10 = r10.m1284getLambda1$material_release()
    ...
    public final IntSize m1288getPopupContentSizebOM6tXw() {
        return (IntSize) this.popupContentSize$delegate.getValue();
    }

    /* renamed from: setPopupContentSize-fhxjrPA */
    public final void m1289setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public void Content(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)300@11761L9:ExposedDropdownMenuPopup.kt#mnwmf7");
    ...
    public final void updatePosition() {
        IntSize m1288getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1288getPopupContentSizebOM6tXw = m1288getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long m4270unboximpl = m1288getPopupContentSizebOM6tXw.m4270unboximpl();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long mo821calculatePositionllwVHH4 = this.positionProvider.mo821calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, m4270unboximpl);
        this.params.x = IntOffset.m4224getXimpl(mo821calculatePositionllwVHH4);
        this.params.y = IntOffset.m4225getYimpl(mo821calculatePositionllwVHH4);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L66:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m1448boximpl(r5)
        L82:
