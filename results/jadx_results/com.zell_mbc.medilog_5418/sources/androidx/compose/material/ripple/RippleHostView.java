...
public final class RippleHostView extends View {
    ...
    public final void m1312addRippleKOepWvA(PressInteraction.Press interaction, boolean z, long j, int i, long j2, float f, Function0<Unit> onInvalidateRipple) {
        ...
        m1313updateRipplePropertiesbiQXAtU(j, i, j2, f);
        if (z) {
            unprojectedRipple.setHotspot(Offset.m1459getXimpl(interaction.m363getPressPositionF1C5BW0()), Offset.m1460getYimpl(interaction.m363getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1313updateRipplePropertiesbiQXAtU(long j, int i, long j2, float f) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(i);
        unprojectedRipple.m1320setColorDxMtmZc(j2, f);
        Rect androidRect = RectHelper_androidKt.toAndroidRect(SizeKt.m1549toRectuvyYCjk(j));
        ...
        if (!z && longValue < 5) {
            Runnable runnable2 = new Runnable() { // from class: androidx.compose.material.ripple.RippleHostView$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RippleHostView.m1311setRippleState$lambda2(RippleHostView.this);
                }
            };
    ...
    public static final void m1311setRippleState$lambda2(RippleHostView this$0) {
    ...
    /* compiled from: RippleHostView.android.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Landroidx/compose/material/ripple/RippleHostView$Companion;", "", "()V", "MinimumRippleStateChangeTime", "", "PressedState", "", "ResetRippleDelayDuration", "RestingState", "material-ripple_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    /* loaded from: classes.dex */
