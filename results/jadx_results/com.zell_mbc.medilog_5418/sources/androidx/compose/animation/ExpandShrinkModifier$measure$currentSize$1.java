...
final class ExpandShrinkModifier$measure$currentSize$1 extends Lambda implements Function1<EnterExitState, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
        return IntSize.m4258boximpl(m81invokeYEO4UFw(enterExitState));
    }

    /* renamed from: invoke-YEO4UFw */
    public final long m81invokeYEO4UFw(EnterExitState it) {
        Intrinsics.checkNotNullParameter(it, "it");
        return this.this$0.m79sizeByStateUzc_VyU(it, this.$measuredSize);
    }
}
