...
public final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    /* renamed from: targetValueByState-oFUgxo0 */
    public final long m97targetValueByStateoFUgxo0(EnterExitState targetState, long j) {
        ...
        long m4234getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.Companion.m4234getZeronOccac() : slideOffset2.invoke(IntSize.m4258boximpl(j)).m4233unboximpl();
        Slide value2 = this.slideOut.getValue();
        long m4234getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.Companion.m4234getZeronOccac() : slideOffset.invoke(IntSize.m4258boximpl(j)).m4233unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return m4234getZeronOccac;
            }
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            return m4234getZeronOccac2;
        }
    ...
    public MeasureResult mo29measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3206measureBRTryo0.getWidth(), mo3206measureBRTryo0.getHeight(), null, new SlideModifier$measure$1(this, mo3206measureBRTryo0, IntSizeKt.IntSize(mo3206measureBRTryo0.getWidth(), mo3206measureBRTryo0.getHeight())), 4, null);
    }
}
