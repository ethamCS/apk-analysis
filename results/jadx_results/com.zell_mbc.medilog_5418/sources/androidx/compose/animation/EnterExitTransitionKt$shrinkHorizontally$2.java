...
final class EnterExitTransitionKt$shrinkHorizontally$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m4258boximpl(m70invokemzRDjE0(intSize.m4270unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0 */
    public final long m70invokemzRDjE0(long j) {
        return IntSizeKt.IntSize(this.$targetWidth.invoke(Integer.valueOf(IntSize.m4266getWidthimpl(j))).intValue(), IntSize.m4265getHeightimpl(j));
    }
}
