...
final class EnterExitTransitionKt$expandVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m4258boximpl(m67invokemzRDjE0(intSize.m4270unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0 */
    public final long m67invokemzRDjE0(long j) {
        return IntSizeKt.IntSize(IntSize.m4266getWidthimpl(j), this.$initialHeight.invoke(Integer.valueOf(IntSize.m4265getHeightimpl(j))).intValue());
    }
}
