...
final class EnterExitTransitionKt$shrinkVertically$2 extends Lambda implements Function1<IntSize, IntSize> {
    ...
    public /* bridge */ /* synthetic */ IntSize invoke(IntSize intSize) {
        return IntSize.m4258boximpl(m72invokemzRDjE0(intSize.m4270unboximpl()));
    }

    /* renamed from: invoke-mzRDjE0 */
    public final long m72invokemzRDjE0(long j) {
        return IntSizeKt.IntSize(IntSize.m4266getWidthimpl(j), this.$targetHeight.invoke(Integer.valueOf(IntSize.m4265getHeightimpl(j))).intValue());
    }
}
