...
public interface FloatAnimationSpec extends AnimationSpec<Float> {
    ...
    public static final class DefaultImpls {
        ...
        public static <V extends AnimationVector> VectorizedFloatAnimationSpec<V> vectorize(FloatAnimationSpec floatAnimationSpec, TwoWayConverter<Float, V> converter) {
            ...
            return CC.$default$vectorize(floatAnimationSpec, (TwoWayConverter) converter);
        }
    }

    /* compiled from: FloatAnimationSpec.kt */
    /* renamed from: androidx.compose.animation.core.FloatAnimationSpec$-CC */
    /* loaded from: classes.dex */
    public final /* synthetic */ class CC {
        ...
        public static VectorizedFloatAnimationSpec $default$vectorize(FloatAnimationSpec _this, TwoWayConverter converter) {
            Intrinsics.checkNotNullParameter(converter, "converter");
