...
public final class HitTestResult<T> implements List<T>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long m3329findBestHitDistanceptXAw2c = m3329findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m3324getDistanceimpl(m3329findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m3326isInLayerimpl(m3329findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndInLayer.m3320compareToS_HNhKs(m3329findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }

    /* renamed from: findBestHitDistance-ptXAw2c */
    private final long m3329findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        ...
        if (i <= lastIndex) {
            while (true) {
                long m3321constructorimpl = DistanceAndInLayer.m3321constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m3320compareToS_HNhKs(m3321constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m3321constructorimpl;
                }
                if (DistanceAndInLayer.m3324getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m3326isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final void speculativeHit(T t, float f, boolean z, Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(t, f, z, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m3320compareToS_HNhKs(m3329findBestHitDistanceptXAw2c, m3329findBestHitDistanceptXAw2c()) > 0) {
