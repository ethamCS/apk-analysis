...
public abstract class AlignmentLines {
    ...
    protected abstract long mo3292calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = mo3292calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            i2 = MathKt.roundToInt(Offset.m1460getYimpl(Offset));
        } else {
            i2 = MathKt.roundToInt(Offset.m1459getXimpl(Offset));
        }
