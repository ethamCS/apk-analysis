...
public final class LayerPositionalProperties {
    ...
    private long transformOrigin = TransformOrigin.Companion.m2042getCenterSzJe1aQ();
    ...
    public final void copyFrom(GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo1838getTransformOriginSzJe1aQ();
    }
                        ...
                        if (this.rotationX == other.rotationX) {
                            if (this.rotationY == other.rotationY) {
                                if (this.rotationZ == other.rotationZ) {
                                    if ((this.cameraDistance == other.cameraDistance) && TransformOrigin.m2036equalsimpl0(this.transformOrigin, other.transformOrigin)) {
                                        return true;
                                    }
                                }
                            }
