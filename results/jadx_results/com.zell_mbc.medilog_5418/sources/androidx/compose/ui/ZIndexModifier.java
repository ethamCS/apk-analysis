...
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo29measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3206measureBRTryo0.getWidth(), mo3206measureBRTryo0.getHeight(), null, new ZIndexModifier$measure$1(mo3206measureBRTryo0, this), 4, null);
    }
