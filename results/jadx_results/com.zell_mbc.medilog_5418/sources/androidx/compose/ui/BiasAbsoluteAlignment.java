...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo1355alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m4266getWidthimpl(j2) - IntSize.m4266getWidthimpl(j), IntSize.m4265getHeightimpl(j2) - IntSize.m4265getHeightimpl(j));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m4266getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m4265getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
