...
public final class RotaryScrollEvent implements FocusDirectedInputEvent {
    ...
    public int hashCode() {
        return ((((0 + Float.floatToIntBits(this.verticalScrollPixels)) * 31) + Float.floatToIntBits(this.horizontalScrollPixels)) * 31) + FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(this.uptimeMillis);
    }
