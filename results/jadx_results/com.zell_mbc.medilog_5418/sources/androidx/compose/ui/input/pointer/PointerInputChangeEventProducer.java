...
public final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3059boximpl(pointerInputEventData.m3090getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j2 = pointerInputEventData.getUptime();
                j = pointerInputEventData.m3091getPositionF1C5BW0();
                z = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j2 = uptime;
                z = pointerInputData.getDown();
                j = positionCalculator.mo3159screenToLocalMKHz9U(pointerInputData.m3081getPositionOnScreenF1C5BW0());
            }
            linkedHashMap.put(PointerId.m3059boximpl(pointerInputEventData.m3090getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3090getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3091getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j2, j, z, false, pointerInputEventData.m3094getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3093getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3059boximpl(pointerInputEventData.m3090getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3092getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3094getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3059boximpl(pointerInputEventData.m3090getIdJ3iCeTQ()));
            }
        }
    ...
    public static final class PointerInputData {
        ...
        public final int m3082getTypeT8wyACA() {
            return this.type;
        }
    }
}
