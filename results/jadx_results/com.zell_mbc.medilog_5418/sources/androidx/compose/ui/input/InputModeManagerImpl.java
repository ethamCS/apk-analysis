...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m2328boximpl(i), null, 2, null);
        this.inputMode$delegate = mutableStateOf$default;
    }

    @Override // androidx.compose.ui.input.InputModeManager
    /* renamed from: getInputMode-aOaMEAU */
    public int mo2337getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m2334unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84 */
    public void m2339setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m2328boximpl(i));
    }

    @Override // androidx.compose.ui.input.InputModeManager
    @ExperimentalComposeUiApi
    /* renamed from: requestInputMode-iuPiT84 */
    public boolean mo2338requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m2328boximpl(i)).booleanValue();
    }
}
