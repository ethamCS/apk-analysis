...
public interface Canvas {
    ...
    void mo1553clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo1554clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: clipRect-mtrdD-E */
    void mo1555clipRectmtrdDE(Rect rect, int i);

    /* renamed from: concat-58bKbWc */
    void mo1556concat58bKbWc(float[] fArr);
    ...
    void mo1557drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo1558drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo1559drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo1560drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo1561drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo1562drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo1563drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m1670clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1685getIntersectrtfAjoo();
                }
                canvas.mo1555clipRectmtrdDE(rect, i);
                return;
            }
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }

        /* renamed from: $default$clipRect-mtrdD-E */
        public static void m1666$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            _this.mo1554clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default */
        public static /* synthetic */ void m1669clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 16) != 0) {
                    i = ClipOp.Companion.m1685getIntersectrtfAjoo();
                }
                canvas.mo1554clipRectN_I0leg(f, f2, f3, f4, i);
                return;
            }
        ...
        public static /* synthetic */ void m1668clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1685getIntersectrtfAjoo();
                }
                canvas.mo1553clipPathmtrdDE(path, i);
                return;
            }
        ...
        public static /* synthetic */ void m1671drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj == null) {
                long m4234getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m4234getZeronOccac() : j;
                long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
                canvas.mo1559drawImageRectHPBpro0(imageBitmap, m4234getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.Companion.m4234getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
                return;
            }
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        /* renamed from: clipRect-mtrdD-E */
        public static void m1674clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            CC.m1666$default$clipRectmtrdDE(canvas, rect, i);
        }
