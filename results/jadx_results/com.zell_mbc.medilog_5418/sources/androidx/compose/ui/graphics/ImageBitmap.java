...
public interface ImageBitmap {
    ...
    /* compiled from: ImageBitmap.kt */
    /* renamed from: androidx.compose.ui.graphics.ImageBitmap$-CC */
    /* loaded from: classes.dex */
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void readPixels$default(ImageBitmap imageBitmap, int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, Object obj) {
            if (obj == null) {
                ...
                int height = (i7 & 16) != 0 ? imageBitmap.getHeight() : i4;
                if ((i7 & 32) == 0) {
                    i8 = i5;
                }
                imageBitmap.readPixels(iArr, i9, i10, width, height, i8, (i7 & 64) != 0 ? width : i6);
                return;
            }
