...
public final class RenderEffectKt {
    /* renamed from: BlurEffect-3YTHUZs$default */
    public static /* synthetic */ BlurEffect m1969BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.Companion.m2024getClamp3opZhB0();
        }
        return m1968BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs */
    public static final BlurEffect m1968BlurEffect3YTHUZs(float f, float f2, int i) {
