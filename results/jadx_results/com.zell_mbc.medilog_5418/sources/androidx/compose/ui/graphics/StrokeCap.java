...
public final class StrokeCap {
    ...
    private static final int Butt = m1998constructorimpl(0);
    private static final int Round = m1998constructorimpl(1);
    private static final int Square = m1998constructorimpl(2);

    /* renamed from: box-impl */
    public static final /* synthetic */ StrokeCap m1997boximpl(int i) {
    ...
    public static boolean m1999equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeCap) && i == ((StrokeCap) obj).m2003unboximpl();
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: getButt-KaPHkGw */
        public final int m2004getButtKaPHkGw() {
            return StrokeCap.Butt;
        }

        /* renamed from: getRound-KaPHkGw */
        public final int m2005getRoundKaPHkGw() {
            return StrokeCap.Round;
        }

        /* renamed from: getSquare-KaPHkGw */
        public final int m2006getSquareKaPHkGw() {
    ...
    public static String m2002toStringimpl(int i) {
        return m2000equalsimpl0(i, Butt) ? "Butt" : m2000equalsimpl0(i, Round) ? "Round" : m2000equalsimpl0(i, Square) ? "Square" : "Unknown";
    }
}
