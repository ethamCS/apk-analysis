...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.Companion.m2004getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m2015getMiterLxFBmk8();
    ...
    public /* synthetic */ Stroke(float f, float f2, int i, int i2, PathEffect pathEffect, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f, (i3 & 2) != 0 ? 4.0f : f2, (i3 & 4) != 0 ? StrokeCap.Companion.m2004getButtKaPHkGw() : i, (i3 & 8) != 0 ? StrokeJoin.Companion.m2015getMiterLxFBmk8() : i2, (i3 & 16) != 0 ? null : pathEffect, null);
    }

    /* renamed from: getCap-KaPHkGw */
    public final int m2261getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8 */
    public final int m2262getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: getDefaultCap-KaPHkGw */
        public final int m2263getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8 */
        public final int m2264getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m2000equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2010equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int floatToIntBits = ((((((Float.floatToIntBits(this.width) * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m2001hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2011hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return floatToIntBits + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2002toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2012toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
