...
public final class DrawTransformKt {
    ...
    /* renamed from: rotateRad-0AR0LA0$default */
    public static /* synthetic */ void m2258rotateRad0AR0LA0$default(DrawTransform rotateRad, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = rotateRad.mo2125getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2127rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: rotateRad-0AR0LA0 */
    public static final void m2257rotateRad0AR0LA0(DrawTransform rotateRad, float f, long j) {
        Intrinsics.checkNotNullParameter(rotateRad, "$this$rotateRad");
        rotateRad.mo2127rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: scale-0AR0LA0$default */
    public static /* synthetic */ void m2260scale0AR0LA0$default(DrawTransform scale, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = scale.mo2125getCenterF1C5BW0();
        }
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2128scale0AR0LA0(f, f, j);
    }

    /* renamed from: scale-0AR0LA0 */
    public static final void m2259scale0AR0LA0(DrawTransform scale, float f, long j) {
        Intrinsics.checkNotNullParameter(scale, "$this$scale");
        scale.mo2128scale0AR0LA0(f, f, j);
    }
