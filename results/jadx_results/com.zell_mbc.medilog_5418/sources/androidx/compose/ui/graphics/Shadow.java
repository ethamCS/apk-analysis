...
public final class Shadow {
    ...
    public static /* synthetic */ void m1981getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations */
    public static /* synthetic */ void m1982getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m1475getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }

    /* renamed from: getColor-0d7_KjU */
    public final long m1984getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0 */
    public final long m1985getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Color.m1697equalsimpl0(this.color, shadow.color) || !Offset.m1456equalsimpl0(this.offset, shadow.offset)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((Color.m1703hashCodeimpl(this.color) * 31) + Offset.m1461hashCodeimpl(this.offset)) * 31) + Float.floatToIntBits(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m1704toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m1467toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default */
    public static /* synthetic */ Shadow m1980copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.color;
        }
        long j3 = j;
        ...
        return shadow.m1983copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM */
    public final Shadow m1983copyqcb84PM(long j, long j2, float f) {
