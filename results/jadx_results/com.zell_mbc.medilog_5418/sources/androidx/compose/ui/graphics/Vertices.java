...
public final class Vertices {
    ...
    public final int m2053getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m1751toArgb8_81llA(list.get(i).m1706unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m1469unboximpl = list.get(i / 2).m1469unboximpl();
            if (i % 2 == 0) {
                f = Offset.m1459getXimpl(m1469unboximpl);
            } else {
                f = Offset.m1460getYimpl(m1469unboximpl);
            }
            fArr[i] = f;
        }
        return fArr;
