...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m2270BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.Companion.m4234getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m1782getLowfv9h1I();
        }
        return m2269BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY */
    public static final BitmapPainter m2269BitmapPainterQZhYCtY(ImageBitmap image, long j, long j2, int i) {
        Intrinsics.checkNotNullParameter(image, "image");
        BitmapPainter bitmapPainter = new BitmapPainter(image, j, j2, null);
        bitmapPainter.m2268setFilterQualityvDHp3xo$ui_graphics_release(i);
