...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m1737tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m1638getSrcIn0nO6VwU();
            }
            return companion.m1740tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds */
        public final ColorFilter m1740tintxETnrds(long j, int i) {
            return AndroidColorFilter_androidKt.m1567actualTintColorFilterxETnrds(j, i);
        }

        /* renamed from: colorMatrix-jHG-Opc */
        public final ColorFilter m1738colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m1565actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI */
        public final ColorFilter m1739lightingOWjLjI(long j, long j2) {
            return AndroidColorFilter_androidKt.m1566actualLightingColorFilterOWjLjI(j, j2);
        }
    }
