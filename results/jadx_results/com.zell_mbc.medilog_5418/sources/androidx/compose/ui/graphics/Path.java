...
public interface Path {
    ...
    void mo1591addPathUv8p0NA(Path path, long j);
    ...
    boolean mo1593opN5in7k0(Path path, Path path2, int i);
    ...
    void mo1594setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M */
    void mo1595translatek4lQ0M(long j);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m1932addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    j = Offset.Companion.m1475getZeroF1C5BW0();
                }
                path.mo1591addPathUv8p0NA(path2, j);
                return;
            }
    ...
    public static final class Companion {
        ...
        public final Path m1933combinexh6zSI8(int i, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo1593opN5in7k0(path1, path2, i)) {
                return Path;
            }
