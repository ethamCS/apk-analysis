...
public abstract class ShaderBrush extends Brush {
    private long createdSize = Size.Companion.m1536getUnspecifiedNHjbRc();
    private Shader internalShader;

    /* renamed from: createShader-uvyYCjk */
    public abstract Shader mo1665createShaderuvyYCjk(long j);
    ...
    public final void mo1643applyToPq9zytI(long j, Paint p, float f) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m1524equalsimpl0(this.createdSize, j)) {
            shader = mo1665createShaderuvyYCjk(j);
            this.internalShader = shader;
            this.createdSize = j;
        }
        if (!Color.m1697equalsimpl0(p.mo1574getColor0d7_KjU(), Color.Companion.m1722getBlack0d7_KjU())) {
            p.mo1580setColor8_81llA(Color.Companion.m1722getBlack0d7_KjU());
        }
