...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m2029boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl */
    public static long m2032constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl */
    public static boolean m2035equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).m2041unboximpl();
    }
    ...
    public static int m2039hashCodeimpl(long j) {
        return FlingCalculator$FlingInfo$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: toString-impl */
    public static String m2040toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m2035equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2039hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m2040toStringimpl(this.packedValue);
    }
    ...
    public static final float m2030component1impl(long j) {
        return m2037getPivotFractionXimpl(j);
    }

    /* renamed from: component2-impl */
    public static final float m2031component2impl(long j) {
        return m2038getPivotFractionYimpl(j);
    }

    /* renamed from: copy-zey9I6w$default */
    public static /* synthetic */ long m2034copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m2037getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m2038getPivotFractionYimpl(j);
        }
        return m2033copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w */
    public static final long m2033copyzey9I6w(long j, float f, float f2) {
    ...
    public static final class Companion {
        ...
        /* renamed from: getCenter-SzJe1aQ */
        public final long m2042getCenterSzJe1aQ() {
            return TransformOrigin.Center;
        }
    }

    /* renamed from: getPivotFractionX-impl */
    public static final float m2037getPivotFractionXimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getPivotFractionY-impl */
    public static final float m2038getPivotFractionYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
