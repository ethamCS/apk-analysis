...
public final class AndroidPath implements Path {
    ...
    public int mo1592getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m1943getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m1944getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U */
    public void mo1594setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m1939equalsimpl0(i, PathFillType.Companion.m1943getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1434getXimpl(roundRect.m1509getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1435getYimpl(roundRect.m1509getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1434getXimpl(roundRect.m1510getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1435getYimpl(roundRect.m1510getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1434getXimpl(roundRect.m1508getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1435getYimpl(roundRect.m1508getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1434getXimpl(roundRect.m1507getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1435getYimpl(roundRect.m1507getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA */
    public void mo1591addPathUv8p0NA(Path path, long j) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1459getXimpl(j), Offset.m1460getYimpl(j));
            return;
        }
    ...
    public void mo1595translatek4lQ0M(long j) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1459getXimpl(j), Offset.m1460getYimpl(j));
    ...
    public boolean mo1593opN5in7k0(Path path1, Path path2, int i) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m1948equalsimpl0(i, PathOperation.Companion.m1952getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m1948equalsimpl0(i, PathOperation.Companion.m1953getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m1948equalsimpl0(i, PathOperation.Companion.m1954getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m1948equalsimpl0(i, PathOperation.Companion.m1955getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
