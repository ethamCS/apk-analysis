...
public final class AndroidPaint_androidKt {
    ...
    /* renamed from: setNativeBlendMode-GB0RdKg */
    public static final void m1585setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int i) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m2054setBlendModeGB0RdKg(setNativeBlendMode, i);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m1552toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    /* renamed from: setNativeColor-4WTKRHQ */
    public static final void m1586setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long j) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m1751toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU */
    public static final void m1590setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int i) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m1926equalsimpl0(i, PaintingStyle.Companion.m1931getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.Companion.m1931getStrokeTiuSbCo();
        }
        return PaintingStyle.Companion.m1930getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i != 1) {
            if (i == 2) {
                return StrokeCap.Companion.m2005getRoundKaPHkGw();
            }
            if (i == 3) {
                return StrokeCap.Companion.m2006getSquareKaPHkGw();
            }
            return StrokeCap.Companion.m2004getButtKaPHkGw();
        }
        return StrokeCap.Companion.m2004getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk */
    public static final void m1588setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int i) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m2000equalsimpl0(i, StrokeCap.Companion.m2006getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m2000equalsimpl0(i, StrokeCap.Companion.m2005getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2000equalsimpl0(i, StrokeCap.Companion.m2004getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i != 1) {
            if (i == 2) {
                return StrokeJoin.Companion.m2014getBevelLxFBmk8();
            }
            if (i == 3) {
                return StrokeJoin.Companion.m2016getRoundLxFBmk8();
            }
            return StrokeJoin.Companion.m2015getMiterLxFBmk8();
        }
        return StrokeJoin.Companion.m2015getMiterLxFBmk8();
    }

    /* renamed from: setNativeStrokeJoin-kLtJ_vA */
    public static final void m1589setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int i) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m2010equalsimpl0(i, StrokeJoin.Companion.m2015getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m2010equalsimpl0(i, StrokeJoin.Companion.m2014getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2010equalsimpl0(i, StrokeJoin.Companion.m2016getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        ...
        if (!paint.isFilterBitmap()) {
            return FilterQuality.Companion.m1784getNonefv9h1I();
        }
        return FilterQuality.Companion.m1782getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU */
    public static final void m1587setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int i) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m1777equalsimpl0(i, FilterQuality.Companion.m1784getNonefv9h1I()));
    }
