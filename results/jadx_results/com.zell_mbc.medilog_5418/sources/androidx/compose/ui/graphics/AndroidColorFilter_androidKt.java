...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1567actualTintColorFilterxETnrds(long j, int i) {
        PorterDuffColorFilter porterDuffColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            porterDuffColorFilter = BlendModeColorFilterHelper.INSTANCE.m1642BlendModeColorFilterxETnrds(j, i);
        } else {
            porterDuffColorFilter = new PorterDuffColorFilter(ColorKt.m1751toArgb8_81llA(j), AndroidBlendMode_androidKt.m1552toPorterDuffModes9anfk8(i));
        }
        return new ColorFilter(porterDuffColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc */
    public static final ColorFilter m1565actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI */
    public static final ColorFilter m1566actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1751toArgb8_81llA(j), ColorKt.m1751toArgb8_81llA(j2)));
    }
}
