...
public final class VectorComponent extends VNode {
    ...
    private long previousDrawSize = Size.Companion.m1536getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m1524equalsimpl0(this.previousDrawSize, drawScope.mo2115getSizeNHjbRc())) {
            this.root.setScaleX(Size.m1528getWidthimpl(drawScope.mo2115getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m1525getHeightimpl(drawScope.mo2115getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m2274drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m1528getWidthimpl(drawScope.mo2115getSizeNHjbRc())), (int) Math.ceil(Size.m1525getHeightimpl(drawScope.mo2115getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo2115getSizeNHjbRc();
        }
