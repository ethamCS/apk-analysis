...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m1988constructorimpl(0);
    private static final int Rotate = m1988constructorimpl(1);
    private static final int Morph = m1988constructorimpl(2);

    /* renamed from: box-impl */
    public static final /* synthetic */ StampedPathEffectStyle m1987boximpl(int i) {
    ...
    public static boolean m1989equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m1993unboximpl();
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: getTranslate-Ypspkwk */
        public final int m1996getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk */
        public final int m1995getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk */
        public final int m1994getMorphYpspkwk() {
    ...
    public static String m1992toStringimpl(int i) {
        return m1990equalsimpl0(i, Translate) ? "Translate" : m1990equalsimpl0(i, Rotate) ? "Rotate" : m1990equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}
