    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m4001from8_81llA(TextDrawStyleKt.m4000modulateDxMtmZc(((SolidColor) brush).m1986getValue0d7_KjU(), f));
            }
        ...
        public final TextForegroundStyle m4001from8_81llA(long j) {
            return (j > Color.Companion.m1732getUnspecified0d7_KjU() ? 1 : (j == Color.Companion.m1732getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(j, null) : Unspecified.INSTANCE;
        }
    }
}
