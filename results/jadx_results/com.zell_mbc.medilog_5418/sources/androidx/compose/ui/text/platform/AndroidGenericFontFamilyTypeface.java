...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo3859getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        Typeface m3860buildStyledTypefaceFO1MlWM = m3860buildStyledTypefaceFO1MlWM(fontWeight, i);
        Intrinsics.checkNotNullExpressionValue(m3860buildStyledTypefaceFO1MlWM, "buildStyledTypeface(fontWeight, fontStyle)");
        return m3860buildStyledTypefaceFO1MlWM;
    }

    /* renamed from: buildStyledTypeface-FO1MlWM */
    private final Typeface m3860buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int i) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, AndroidFontUtils_androidKt.m3709getAndroidTypefaceStyleFO1MlWM(fontWeight, i));
        }
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m3754equalsimpl0(i, FontStyle.Companion.m3758getItalic_LCdwA()));
    }
}
