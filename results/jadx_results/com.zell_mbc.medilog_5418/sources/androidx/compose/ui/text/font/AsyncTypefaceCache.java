...
public final class AsyncTypefaceCache {
    private final Object PermanentFailure = AsyncTypefaceResult.m3713constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m3712boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl */
        public static Object m3713constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl */
        public static boolean m3714equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m3719unboximpl());
        }
        ...
        public static int m3716hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        /* renamed from: isPermanentFailure-impl */
        public static final boolean m3717isPermanentFailureimpl(Object obj) {
            return obj == null;
        }

        /* renamed from: toString-impl */
        public static String m3718toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m3714equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m3716hashCodeimpl(this.result);
        }

        public String toString() {
            return m3718toStringimpl(this.result);
        }

        /* renamed from: unbox-impl */
        public final /* synthetic */ Object m3719unboximpl() {
            return this.result;
        }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object obj, boolean z) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (obj == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m3712boximpl(this.PermanentFailure));
                } else if (z) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m3712boximpl(AsyncTypefaceResult.m3713constructorimpl(obj)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m3712boximpl(AsyncTypefaceResult.m3713constructorimpl(obj)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m3711get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r6, androidx.compose.ui.text.font.PlatformFontLoader r7, boolean r8, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<java.lang.Object> r10) {
        ...
        L5d:
            if (r7 == 0) goto L65
            java.lang.Object r7 = r7.m3719unboximpl()     // Catch: java.lang.Throwable -> Lb1
            monitor-exit(r6)
            return r7
        L65:
        ...
        L7b:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r7 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m3712boximpl(r7)     // Catch: java.lang.Throwable -> L8c
        ...
        L8e:
            ...
            java.lang.Object r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m3713constructorimpl(r10)     // Catch: java.lang.Throwable -> L8c
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m3712boximpl(r8)     // Catch: java.lang.Throwable -> L8c
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                if (asyncTypefaceResult != null) {
                    Object m3719unboximpl = asyncTypefaceResult.m3719unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return m3719unboximpl;
                }
