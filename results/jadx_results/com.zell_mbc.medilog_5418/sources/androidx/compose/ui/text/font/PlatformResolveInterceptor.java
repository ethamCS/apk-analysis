...
public interface PlatformResolveInterceptor {
    ...
    /* compiled from: FontFamilyResolver.kt */
    /* renamed from: androidx.compose.ui.text.font.PlatformResolveInterceptor$-CC */
    /* loaded from: classes.dex */
    public final /* synthetic */ class CC {
        ...
        /* renamed from: $default$interceptFontStyle-T2F_aPo */
        public static int m3777$default$interceptFontStyleT2F_aPo(PlatformResolveInterceptor _this, int i) {
            return i;
        }

        /* renamed from: $default$interceptFontSynthesis-Mscr08Y */
        public static int m3778$default$interceptFontSynthesisMscr08Y(PlatformResolveInterceptor _this, int i) {
            return i;
        }
    }
    ...
    int mo3707interceptFontStyleT2F_aPo(int i);

    /* renamed from: interceptFontSynthesis-Mscr08Y */
    int mo3708interceptFontSynthesisMscr08Y(int i);
    ...
    public static final class Companion {
        ...
        private static final PlatformResolveInterceptor Default = new PlatformResolveInterceptor() { // from class: androidx.compose.ui.text.font.PlatformResolveInterceptor$Companion$Default$1
            ...
            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontStyle-T2F_aPo */
            public /* synthetic */ int mo3707interceptFontStyleT2F_aPo(int i) {
                return PlatformResolveInterceptor.CC.m3777$default$interceptFontStyleT2F_aPo(this, i);
            }

            @Override // androidx.compose.ui.text.font.PlatformResolveInterceptor
            /* renamed from: interceptFontSynthesis-Mscr08Y */
            public /* synthetic */ int mo3708interceptFontSynthesisMscr08Y(int i) {
                return PlatformResolveInterceptor.CC.m3778$default$interceptFontSynthesisMscr08Y(this, i);
            }
