...
public final class TextLayoutResult {
    ...
    public final long m3645getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m4265getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m4266getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m3644getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m3575getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m3646getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m3576getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m3642copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m3643copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c */
    public final TextLayoutResult m3643copyO0kMr_c(TextLayoutInput layoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) || !Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.m4264equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m4267hashCodeimpl(this.size)) * 31) + Float.floatToIntBits(this.firstBaseline)) * 31) + Float.floatToIntBits(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m4269toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
