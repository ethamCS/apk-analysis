...
public final class FontMatcher {
    ...
    /* renamed from: matchFont-RetOiIg */
    public final List<Font> m3748matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m3749matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg */
    public final List<Font> m3749matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m3750matchFontRetOiIg(fontFamily.getFonts(), fontWeight, i);
    }

    /* renamed from: matchFont-RetOiIg */
    public final List<Font> m3750matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int i) {
        ...
        while (true) {
            ...
            Font font2 = font;
            if (!Intrinsics.areEqual(font2.getWeight(), fontWeight) || !FontStyle.m3754equalsimpl0(font2.mo3710getStyle_LCdwA(), i)) {
                z = false;
            }
            if (z) {
                arrayList.add(font);
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (FontStyle.m3754equalsimpl0(font3.mo3710getStyle_LCdwA(), i)) {
