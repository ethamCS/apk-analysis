...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo3859getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m3709getAndroidTypefaceStyleFO1MlWM(fontWeight, i));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m3754equalsimpl0(i, FontStyle.Companion.m3758getItalic_LCdwA()));
    }
}
