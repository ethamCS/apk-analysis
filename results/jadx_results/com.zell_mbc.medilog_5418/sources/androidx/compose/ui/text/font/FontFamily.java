...
public abstract class FontFamily {
    ...
    public interface Resolver {
        ...
        State<Object> mo3730resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2);

        /* compiled from: FontFamily.kt */
        /* renamed from: androidx.compose.ui.text.font.FontFamily$Resolver$-CC */
        /* loaded from: classes.dex */
        public final /* synthetic */ class CC {
            /* renamed from: resolve-DPcqOEQ$default */
            public static /* synthetic */ State m3731resolveDPcqOEQ$default(Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
                if (obj == null) {
                    if ((i3 & 1) != 0) {
                        fontFamily = null;
                    }
                    ...
                    if ((i3 & 4) != 0) {
                        i = FontStyle.Companion.m3759getNormal_LCdwA();
                    }
                    if ((i3 & 8) != 0) {
                        i2 = FontSynthesis.Companion.m3769getAllGVVA2EU();
                    }
                    return resolver.mo3730resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                }
