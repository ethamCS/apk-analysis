...
final class SaversKt$OffsetSaver$2 extends Lambda implements Function1<Object, Offset> {
    ...
    /* renamed from: invoke-x-9fifI */
    public final Offset invoke(Object it) {
        Intrinsics.checkNotNullParameter(it, "it");
        if (Intrinsics.areEqual(it, (Object) false)) {
            return Offset.m1448boximpl(Offset.Companion.m1474getUnspecifiedF1C5BW0());
        }
        List list = (List) it;
        ...
        return Offset.m1448boximpl(OffsetKt.Offset(floatValue, f.floatValue()));
    }
}
