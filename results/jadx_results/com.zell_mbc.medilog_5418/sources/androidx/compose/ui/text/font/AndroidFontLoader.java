...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) {
        ...
        if (font instanceof AndroidFont) {
            ...
            int mo3698getLoadingStrategyPKNRLFQ = font.mo3698getLoadingStrategyPKNRLFQ();
            if (FontLoadingStrategy.m3741equalsimpl0(mo3698getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m3746getBlockingPKNRLFQ())) {
                Context context2 = this.context;
                Intrinsics.checkNotNullExpressionValue(context2, "context");
                typeface = AndroidFontLoader_androidKt.load((ResourceFont) font, context2);
            } else if (FontLoadingStrategy.m3741equalsimpl0(mo3698getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m3747getOptionalLocalPKNRLFQ())) {
                try {
                    ...
                    obj = Result.m4749constructorimpl(load);
                } catch (Throwable th) {
                ...
                typeface = (android.graphics.Typeface) obj2;
            } else if (FontLoadingStrategy.m3741equalsimpl0(mo3698getLoadingStrategyPKNRLFQ, FontLoadingStrategy.Companion.m3745getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            } else {
                throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m3743toStringimpl(font.mo3698getLoadingStrategyPKNRLFQ())));
            }
