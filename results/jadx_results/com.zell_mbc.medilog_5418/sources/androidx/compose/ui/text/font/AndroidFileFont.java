...
public final class AndroidFileFont extends AndroidPreloadedFont {
    ...
    public /* synthetic */ AndroidFileFont(File file, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i2 & 2) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i2 & 4) != 0 ? FontStyle.Companion.m3759getNormal_LCdwA() : i, settings, null);
    }
    ...
    public String toString() {
        return "Font(file=" + this.file + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m3756toStringimpl(mo3710getStyle_LCdwA())) + ')';
    }
}
