...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String str, FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m3747getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, settings, null);
        this.familyName = str;
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo3781optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo3710getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DeviceFontFamilyName.m3723equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m3754equalsimpl0(mo3710getStyle_LCdwA(), deviceFontFamilyNameFont.mo3710getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m3724hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m3755hashCodeimpl(mo3710getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m3725toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m3756toStringimpl(mo3710getStyle_LCdwA())) + ')';
    }
}
