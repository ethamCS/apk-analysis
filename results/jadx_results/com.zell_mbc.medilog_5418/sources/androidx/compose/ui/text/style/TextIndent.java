...
public final class TextIndent {
    ...
    public final long m4004getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE */
    public final long m4005getRestLineXSAIIZE() {
    ...
    /* renamed from: copy-NB67dxo$default */
    public static /* synthetic */ TextIndent m4002copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m4003copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo */
    public final TextIndent m4003copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextUnit.m4284equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m4284equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m4288hashCodeimpl(this.firstLine) * 31) + TextUnit.m4288hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m4294toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m4294toStringimpl(this.restLine)) + ')';
    }
}
