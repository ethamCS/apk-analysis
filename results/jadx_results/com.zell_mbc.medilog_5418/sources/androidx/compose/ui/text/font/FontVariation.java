...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        /* renamed from: getValue-XSAIIZE */
        public final long m3776getValueXSAIIZE() {
            return this.value;
        }
        ...
        public float toVariationValue(Density density) {
            ...
            return TextUnit.m4287getValueimpl(this.value) * density.getFontScale();
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual(getAxisName(), settingTextUnit.getAxisName()) && TextUnit.m4284equalsimpl0(this.value, settingTextUnit.value);
        }

        public int hashCode() {
            return (getAxisName().hashCode() * 31) + TextUnit.m4288hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m4294toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m3775opticalSizingR2X_6o(long j) {
        if (!TextUnit.m4290isSpimpl(j)) {
    ...
    public final Settings m3774Settings6EWAqTQ(FontWeight weight, int i, Setting... settings) {
