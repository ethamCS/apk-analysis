...
public final class TextFieldValue {
    ...
    private TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange) {
        ...
        this.selection = TextRangeKt.m3675constrain8ffj60Q(j, 0, getText().length());
        this.composition = textRange != null ? TextRange.m3657boximpl(TextRangeKt.m3675constrain8ffj60Q(textRange.m3673unboximpl(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, (i & 2) != 0 ? TextRange.Companion.m3674getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.Companion.m3674getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public final long m3856getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: getComposition-MzsxiRA */
    public final TextRange m3855getCompositionMzsxiRA() {
        return this.composition;
    }

    /* renamed from: copy-3r_uNRQ$default */
    public static /* synthetic */ TextFieldValue m3851copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m3853copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ */
    public final TextFieldValue m3853copy3r_uNRQ(AnnotatedString annotatedString, long j, TextRange textRange) {
        Intrinsics.checkNotNullParameter(annotatedString, "annotatedString");
        return new TextFieldValue(annotatedString, j, textRange, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default */
    public static /* synthetic */ TextFieldValue m3852copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m3854copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ */
    public final TextFieldValue m3854copy3r_uNRQ(String text, long j, TextRange textRange) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextRange.m3662equalsimpl0(this.selection, textFieldValue.selection) && Intrinsics.areEqual(this.composition, textFieldValue.composition) && Intrinsics.areEqual(this.annotatedString, textFieldValue.annotatedString);
    }

    public int hashCode() {
        int hashCode = ((this.annotatedString.hashCode() * 31) + TextRange.m3670hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return hashCode + (textRange != null ? TextRange.m3670hashCodeimpl(textRange.m3673unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.annotatedString) + "', selection=" + ((Object) TextRange.m3672toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
