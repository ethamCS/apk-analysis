...
public final class FontKt {
    ...
    public static /* synthetic */ Font m3735FontRetOiIg$default(int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i3 & 4) != 0) {
            i2 = FontStyle.Companion.m3759getNormal_LCdwA();
        }
        return m3734FontRetOiIg(i, fontWeight, i2);
    }
    ...
    public static final /* synthetic */ Font m3734FontRetOiIg(int i, FontWeight weight, int i2) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(i, weight, i2, null, FontLoadingStrategy.Companion.m3746getBlockingPKNRLFQ(), 8, null);
    }

    /* renamed from: Font-YpTlLL0$default */
    public static /* synthetic */ Font m3737FontYpTlLL0$default(int i, FontWeight fontWeight, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = FontLoadingStrategy.Companion.m3746getBlockingPKNRLFQ();
        }
        return m3736FontYpTlLL0(i, fontWeight, i2, i3);
    }

    /* renamed from: Font-YpTlLL0 */
    public static final Font m3736FontYpTlLL0(int i, FontWeight weight, int i2, int i3) {
        Intrinsics.checkNotNullParameter(weight, "weight");
    ...
    public static /* synthetic */ Font m3733FontF3nL8kk$default(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i4 & 4) != 0) {
        ...
        if ((i4 & 16) != 0) {
            settings = FontVariation.INSTANCE.m3774Settings6EWAqTQ(fontWeight, i2, new FontVariation.Setting[0]);
        }
        return m3732FontF3nL8kk(i, fontWeight, i2, i3, settings);
    }

    @ExperimentalTextApi
    /* renamed from: Font-F3nL8kk */
    public static final Font m3732FontF3nL8kk(int i, FontWeight weight, int i2, int i3, FontVariation.Settings variationSettings) {
        Intrinsics.checkNotNullParameter(weight, "weight");
