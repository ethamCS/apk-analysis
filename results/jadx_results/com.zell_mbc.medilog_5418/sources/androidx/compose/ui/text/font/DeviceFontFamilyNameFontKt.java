...
public final class DeviceFontFamilyNameFontKt {
    /* renamed from: Font-vxs03AY$default */
    public static /* synthetic */ Font m3728Fontvxs03AY$default(String str, FontWeight fontWeight, int i, FontVariation.Settings settings, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        return m3727Fontvxs03AY(str, fontWeight, i, settings);
    }

    @ExperimentalTextApi
    /* renamed from: Font-vxs03AY */
    public static final Font m3727Fontvxs03AY(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
