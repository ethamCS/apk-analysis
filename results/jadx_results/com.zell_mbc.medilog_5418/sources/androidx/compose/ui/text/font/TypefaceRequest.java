...
public final class TypefaceRequest {
    ...
    /* renamed from: copy-e1PVR60$default */
    public static /* synthetic */ TypefaceRequest m3793copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m3796copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    /* renamed from: component3-_-LCdwA */
    public final int m3794component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU */
    public final int m3795component4GVVA2EU() {
    ...
    /* renamed from: copy-e1PVR60 */
    public final TypefaceRequest m3796copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m3754equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m3763equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily = this.fontFamily;
        int i = 0;
        int hashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m3755hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m3764hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m3756toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m3767toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m3797getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU */
    public final int m3798getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
