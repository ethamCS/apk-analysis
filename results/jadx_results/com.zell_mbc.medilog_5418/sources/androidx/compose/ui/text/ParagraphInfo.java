...
public final class ParagraphInfo {
    ...
    public final long m3581toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1459getXimpl(j), Offset.m1460getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m1496translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo1595translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI */
    public final long m3580toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3669getStartimpl(j)), toGlobalIndex(TextRange.m3664getEndimpl(j)));
    }
}
