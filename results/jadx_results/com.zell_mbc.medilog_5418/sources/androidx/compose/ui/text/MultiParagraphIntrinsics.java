...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle paragraphStyle, ParagraphStyle paragraphStyle2) {
        TextDirection m3594getTextDirectionmmuk1to = paragraphStyle.m3594getTextDirectionmmuk1to();
        if (m3594getTextDirectionmmuk1to != null) {
            m3594getTextDirectionmmuk1to.m3994unboximpl();
            if (paragraphStyle != null) {
                return paragraphStyle;
            }
        }
        return ParagraphStyle.m3586copyElsmlbk$default(paragraphStyle, null, paragraphStyle2.m3594getTextDirectionmmuk1to(), 0L, null, 13, null);
    }
}
