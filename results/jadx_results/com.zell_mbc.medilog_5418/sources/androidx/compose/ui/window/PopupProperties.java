...
public final class PopupProperties {
    ...
    public int hashCode() {
        return (((((((((((((MagnifierStyle$$ExternalSyntheticBackport0.m(this.dismissOnBackPress) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.focusable)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.dismissOnBackPress)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.excludeFromSystemGesture)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.clippingEnabled)) * 31) + MagnifierStyle$$ExternalSyntheticBackport0.m(this.usePlatformDefaultWidth);
    }
}
