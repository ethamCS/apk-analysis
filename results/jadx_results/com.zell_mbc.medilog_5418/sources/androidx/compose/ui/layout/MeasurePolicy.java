...
public interface MeasurePolicy {
    ...
    /* compiled from: MeasurePolicy.kt */
    /* renamed from: androidx.compose.ui.layout.MeasurePolicy$-CC */
    /* loaded from: classes.dex */
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
            ...
            return _this.mo14measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getWidth();
        }
        ...
        public static int $default$minIntrinsicHeight(MeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
            ...
            return _this.mo14measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getHeight();
        }
