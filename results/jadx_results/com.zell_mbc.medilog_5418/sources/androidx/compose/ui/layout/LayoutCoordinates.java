...
public interface LayoutCoordinates {
    ...
    long mo3211localPositionOfR5De75A(LayoutCoordinates layoutCoordinates, long j);

    /* renamed from: localToRoot-MK-Hz9U */
    long mo3212localToRootMKHz9U(long j);

    /* renamed from: localToWindow-MK-Hz9U */
    long mo3213localToWindowMKHz9U(long j);

    /* renamed from: transformFrom-EL8BTi8 */
    void mo3214transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, float[] fArr);

    /* renamed from: windowToLocal-MK-Hz9U */
    long mo3215windowToLocalMKHz9U(long j);

    /* compiled from: LayoutCoordinates.kt */
    /* renamed from: androidx.compose.ui.layout.LayoutCoordinates$-CC */
    /* loaded from: classes.dex */
    public final /* synthetic */ class CC {
        ...
        /* renamed from: $default$transformFrom-EL8BTi8 */
        public static void m3216$default$transformFromEL8BTi8(LayoutCoordinates _this, LayoutCoordinates sourceCoordinates, float[] matrix) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: transformFrom-EL8BTi8 */
        public static void m3218transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            CC.m3216$default$transformFromEL8BTi8(layoutCoordinates, sourceCoordinates, matrix);
        }
    }
}
