...
/* renamed from: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1 */
...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m4104boximpl(this.$elevation$inlined));
        ...
        inspectorInfo.getProperties().set("ambientColor", Color.m1686boximpl(this.$ambientColor$inlined));
        inspectorInfo.getProperties().set("spotColor", Color.m1686boximpl(this.$spotColor$inlined));
    }
}
