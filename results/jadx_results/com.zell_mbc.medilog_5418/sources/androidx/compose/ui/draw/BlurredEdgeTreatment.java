...
public final class BlurredEdgeTreatment {
    ...
    private static final Shape Rectangle = m1362constructorimpl(RectangleShapeKt.getRectangleShape());
    private static final Shape Unbounded = m1362constructorimpl(null);
    private final Shape shape;

    /* renamed from: box-impl */
    public static final /* synthetic */ BlurredEdgeTreatment m1361boximpl(Shape shape) {
        return new BlurredEdgeTreatment(shape);
    }

    /* renamed from: constructor-impl */
    public static Shape m1362constructorimpl(Shape shape) {
        return shape;
    }

    /* renamed from: equals-impl */
    public static boolean m1363equalsimpl(Shape shape, Object obj) {
        return (obj instanceof BlurredEdgeTreatment) && Intrinsics.areEqual(shape, ((BlurredEdgeTreatment) obj).m1367unboximpl());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m1364equalsimpl0(Shape shape, Shape shape2) {
        return Intrinsics.areEqual(shape, shape2);
    }

    /* renamed from: hashCode-impl */
    public static int m1365hashCodeimpl(Shape shape) {
        if (shape == null) {
            return 0;
        }
    ...
    public static String m1366toStringimpl(Shape shape) {
        return "BlurredEdgeTreatment(shape=" + shape + ')';
    }

    public boolean equals(Object obj) {
        return m1363equalsimpl(this.shape, obj);
    }

    public int hashCode() {
        return m1365hashCodeimpl(this.shape);
    }

    public String toString() {
        return m1366toStringimpl(this.shape);
    }

    /* renamed from: unbox-impl */
    public final /* synthetic */ Shape m1367unboximpl() {
        return this.shape;
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: getRectangle---Goahg */
        public final Shape m1368getRectangleGoahg() {
            return BlurredEdgeTreatment.Rectangle;
        }

        /* renamed from: getUnbounded---Goahg */
        public final Shape m1369getUnboundedGoahg() {
