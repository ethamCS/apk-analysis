...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 != 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m5960getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
            return;
        }
    ...
    public final int m5974getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA */
    public final int m5975getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m4888toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m4888toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m5976fromClosedRangeNkh28Cs(int i, int i2, int i3) {
