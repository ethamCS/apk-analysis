...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 != 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m5959getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
            return;
        }
    ...
    public final long m5981getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU */
    public final long m5982getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m4921constructorimpl(j ^ ULong.m4921constructorimpl(j >>> 32))) * 31) + ((int) ULong.m4921constructorimpl(j2 ^ ULong.m4921constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m4966toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m4966toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m5983fromClosedRange7ftBX0g(long j, long j2, long j3) {
