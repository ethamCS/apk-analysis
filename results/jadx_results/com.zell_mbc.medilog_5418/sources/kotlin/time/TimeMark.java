...
public interface TimeMark {
    ...
    TimeMark mo6049minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo6050plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo */
        public static TimeMark m6192plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo */
        public static TimeMark m6191minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo6050plusLRDsOJo(Duration.m6108unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m6089isNegativeimpl(timeMark.mo6048elapsedNowUwyO8pc());
        }
