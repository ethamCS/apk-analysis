...
public final class UIntArrayKt {
    ...
    private static final int[] m4913uintArrayOfajY9A(int... elements) {
    ...
    private static final int[] UIntArray(int i, Function1<? super Integer, UInt> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = init.invoke(Integer.valueOf(i2)).m4894unboximpl();
        }
        return UIntArray.m4897constructorimpl(iArr);
    }
}
